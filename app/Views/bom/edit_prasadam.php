...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>BOM<small>Bom / <a href="#" >Prasadam</a></small></h2>
        </div>
        <!-- Basic Examples -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/bom/prasadam"><button type="button" class="btn bg-deep-purple waves-effect">List</button></a></div></div>
                    </div>
                    <form action="<?php echo base_url(); ?>/bom/save_prasadam" method="POST" enctype="multipart/form-data">
                    <div class="body">
