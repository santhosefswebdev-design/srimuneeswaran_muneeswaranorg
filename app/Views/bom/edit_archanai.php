...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>BOM<small>Bom / <a href="#" >Archanai</a></small></h2>
        </div>
        <!-- Basic Examples -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/bom/archanai"><button type="button" class="btn bg-deep-purple waves-effect">List</button></a></div></div>
                    </div>
                    <form action="<?php echo base_url(); ?>/bom/save_archanai" method="POST" enctype="multipart/form-data">
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-6">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text"  class="form-control" value="<?php echo $data['name_eng'];?>" <?php echo $edit_readonly; ?> <?php echo $readonly; ?>>
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select class="form-control" id="raw_id">
                                                    ...
                                                    <?php foreach($raw_matrials as $product) { ?>
