<section class="content">
    <div class="container-fluid">
        ...
        <h2>Raw Material<small>Product / <b>Raw Material</b></small></h2>
        </div>
        <!-- Basic Examples -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<?php if($permission['create_p'] == 1) { ?>
                    <div class="header">
                        ...
                        <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/rawmaterial/add_product"><button type="button" class="btn bg-deep-purple waves-effect">Add Product</button></a></div></div>
                    </div>
				<?php } ?>
                    <div class="body">
