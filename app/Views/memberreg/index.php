                            ...
                            <div class="container-fluid">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $data['member_no']; ?>"
                                            readonly>
                                        <!--</div>
                                    </div>-->
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div id="bs_datepicker_component_container">
                                            ...
                                            <input type="date" name="start_date" class="form-control"
                                                value="<?php echo ($data['start_date']) ? date("Y-m-d", strtotime($data['start_date'])) : date("Y-m-d"); ?>"
                                                <?php echo $readonly; ?>>
                                        </div>
                                        <!--</div>-->
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <input type="number" step="0.1" id="payment" name="payment" class="form-control"
                                            step=".01" value="<?= $data['payment'] ?>" <?php echo $readonly; ?>>
                                        <!--</div>
                                    </div>-->
                                    </div>
                                    <?php if ($view != true) { ?>
