							...
							<div class="container-fluid">
								<div class="row clearfix">
                                    ...
                                    <div class="col-sm-2">
										<div class="form-group form-float">
											<div class="">
												<br><input type="checkbox" id="rasi" name="rasi" value="1"  class="form-control" >
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:30%;">Name Tamil</th>
                                        <th>Action</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	<a class="btn btn-success btn-rad" title="View" href="<?= base_url()?>/archanai/view_group/<?php echo $row['id'];?>"><i class="material-icons">&#xE417;</i></a>
                                            <a class="btn btn-primary btn-rad" title="Edit" href="<?= base_url()?>/archanai/edit_group/<?php echo $row['id'];?>"><i class="material-icons">&#xE3C9;</i></a>
