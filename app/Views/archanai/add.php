...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2> <?php echo $lang->archanai; echo $lang->setting; ?><small><?php echo $lang->archanai; ?> / <b> Add <?php echo $lang->archanai; echo $lang->setting; ?></b></small></h2>
        </div>
        <!-- Basic Examples -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/archanai"><button type="button" class="btn bg-deep-purple waves-effect">List</button></a></div></div>
                    </div>
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                                    ...
                                    <div class="form-line">
                                        <select name="groupname" id="groupname" class="form-control">
                                            ...
                                            <?php foreach($archanai_group as $row) { ?>
                                                <option value="<?php echo $row['name']; ?>" <?php if($data['groupname'] == $row['name']){ echo "selected"; } ?>><?php echo strtoupper($row['name']); ?></option>
                                            <?php } ?>
                                        </select>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <select class="form-control" id="archanai_category" name="archanai_category" <?php echo $disable; ?> required>
                                            <option value="">Select <?php echo $lang->archanai." ".$lang->category; ?></option>
                                            <?php
                                            if(!empty($archanai_categories))
                                            {
                                                ...
                                                {
                                            ?>
                                            <option value="<?php echo $archanai_categorie['id']; ?>" <?php if(!empty($data['archanai_category'])){ if($data['archanai_category'] == $archanai_categorie['id']){ echo "selected"; }}?>><?php echo $archanai_categorie['name']; ?></option>
                                            <?php
                                                }
                                            }
                                            ?>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <input type="file" id="imgInp" name="archanai_image" accept="image/png,image/jpeg,image/jpg" class="form-control" <?php echo $readonly; ?>>
                            ...
                            <div class="col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="">
											<?php if(!empty($data['image'])) {?>
                                                <a target="_blank" href="/uploads/archanai/<?php echo $data['image']; ?>">
                                                    <img id="img_pre" src="/uploads/archanai/<?php echo $data['image']; ?>" width="200" height="160"></img>
                                                </a>
											<?php } else { ?> 
                            ...
                            <div class="col-sm-2">
                                <div class="form-group form-float">
                                    <div class="form-check" style="margin-top:15px;">
                                        <input class="form-check-input" id="view_archanai" name="view_archanai" <?php if($data['view_archanai'] == '0'){ echo "checked"; } ?> type="checkbox" value="1" id="view_archanai">
                                        <label class="form-check-label" for="view_archanai">
                                        Hide Archanai</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group form-float">
                                    <div class="form-check" style="margin-top:15px;">
                                        <input class="form-check-input" id="is_sep" name="is_sep" <?php if($data['is_sep'] == '1'){ echo "checked"; } ?> type="checkbox" value="1" id="is_sep">
                                        <label class="form-check-label" for="is_sep">
                                        Separate Print</label>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-line">
                                        <select name="diety_id[]" id="diety_id" class="form-control" multiple="multiple">
                                            ...
                                            foreach($archanai_diety as $row) {
                                                $explode_ar_dt = explode(",",$data['diety_id']);
