                                    ...
                                    <div class="col-sm-3">
										<div class="form-diety form-float">
											<div class="form-line">
												...
												<label class="form-label">Name Tamil<span style="color: red;"> *</span></label>
											</div>
										</div>
									</div>
                                    <div class="col-sm-2">
										<div class="form-diety form-float">
											<div class="form-line">
												...
												<label class="form-label">Deity Code<span style="color: red;"> *</span></label>
											</div>
										</div>
									</div>
									<div class="col-sm-2">
										<div class="form-diety form-float">
											<div class="form-line">
												<input type="file" class="form-control" name="image" accept="image/png, image/gif, image/jpeg" value="" >
											</div>
										</div>
									</div>
                                    <div class="col-sm-2">
										<div class="form-diety form-float">
											<div class="form-line">
												<input type="checkbox" id="kattalai" name="kattalai_deity" value="1"  class="form-control" >
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:25%;">Name Tamil</th>
                                        <th style="width:25%;">Deity code</th>
                                        <th>Action</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo strtoupper($row['name_tamil']); ?></td>
                                        <td><?php echo strtoupper($row['code']); ?></td>
                                        <td>
                                        	<a class="btn btn-success btn-rad" title="View" href="<?= base_url()?>/archanai/view_diety/<?php echo $row['id'];?>"><i class="material-icons">&#xE417;</i></a>
                                            <a class="btn btn-primary btn-rad" title="Edit" href="<?= base_url()?>/archanai/edit_diety/<?php echo $row['id'];?>"><i class="material-icons">&#xE3C9;</i></a>
...
<script>
    ...
    function dedDel(id)
    {
        var act = "<?php echo base_url(); ?>/archanai/delete_diety/"+id;
