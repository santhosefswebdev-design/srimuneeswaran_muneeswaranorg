<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2> Archanai Setting<small>Archanai / <b>Natchathiram List</b></small></h2>
            </div>
            <!-- Basic Examples -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<?php if($permission['create_p'] == 1) { ?>
                        <div class="header">
                            ...
                            <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/archanai/natchathiram_add"><button type="button" class="btn bg-deep-purple waves-effect">Add</button></a></div></div>
                        </div>
					<?php } ?>
                        <div class="body">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:30%;">Natchathiram in English</th>
                                            <th style="width:30%;">Natchathiram in Tamil</th>
                                            ...
                                            <?php if($permission['view'] == 1 ||  $permission['edit'] == 1 ||  $permission['delete_p'] == 1) { ?>
                                                <td style="width: 10%;">
                                                    <?php if($permission['view'] == 1) { ?>
                                                        <a class="btn btn-success btn-rad" title="View" href="<?= base_url()?>/archanai/natchathiram_view/<?php echo $row['id'];?>"><i class="material-icons">&#xE417;</i></a>
                                                    <?php }
													if($permission['edit'] == 1) { ?> 
                                                        <a class="btn btn-primary btn-rad" title="Edit" href="<?= base_url()?>/archanai/natchathiram_edit/<?php echo $row['id'];?>"><i class="material-icons">&#xE3C9;</i></a>
                                                    <?php }
                ...
                <div class="modal-content">
                    <div class="modal-body p-4">
                        <div class="text-center">
                            ...
                            <h4 class="mt-2">Delete Natchathiram</h4>
                            <table>
...
<script>
    ...
    function dedDel(id)
    {
        var act = "<?php echo base_url(); ?>/archanai/natchathiram_delete/"+id;
