        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <form action="<?php echo base_url(); ?>/cemetery/save_register" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="body"> 
                        ...
                        <div class="add_box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="d_certif_no" id="d_certif_no">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text"  class="form-control" required name="d_certif_issue" id="d_certif_issue">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focused">
                                            <input type="date" class="form-control" name="d_certif_date" id="d_certif_date">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="b_certif_no" id="b_certif_no">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text"  class="form-control" required name="b_certif_issue" id="b_certif_issue">
                                            <label class="form-label">Issued by <span style="color: red;"> *</span></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focused">
                                            <input type="date" class="form-control" name="b_certif_date" id="b_certif_date">
                                            <label class="form-label">Date of Issue <span style="color: red;"> *</span></label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text"  class="form-control" name="app_nric_new" id="app_nric_new">
                                            <label class="form-label">NRIC New <span style="color: red;"> *</span></label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text"  class="form-control" name="app_phone" id="app_phone">
								...
								<div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focused">
                                            <input type="datetime-local" class="form-control" name="ash_collect_dete" id="ash_collect_dete">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text"  class="form-control" name="ash_collect_by" id="ash_collect_by">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <div class="sign_img_dis_app" style="display: inline;"></div>
                                            <input class="form-control" type="hidden" name="ash_signature" id="ash_signature">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row"><button class="btn btn-success" type="submit">Submit</button>
                    </div>
                    </div>
                    </form>
                </div>
