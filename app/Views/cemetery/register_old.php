                ...
                <div class="card">
                    ...
                    <div class="body"> 
                        ...
                        <div class="add_box">
                            ...
                            <tr>
								<td style="width:5%;">
									<input type="checkbox" name="cemetery_check[<?php echo $ii; ?>]" id="cemetery_check" class="cemetery_check" style="left: 2%;opacity: 1;position: inherit;" class="form-control" value="1">
								</td>
								<td style="width:70%;">
