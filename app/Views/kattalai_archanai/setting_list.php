...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2> Kattalai <?php echo $lang->archanai; echo $lang->setting; ?><small><?php echo $lang->archanai; ?> / <b> Kattalai <?php echo $lang->archanai; echo $lang->list; ?></b></small></h2>
            </div>
            <!-- Basic Examples -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<?php if($permission['create_p'] == 1) { ?>
                        <div class="header">
                            ...
                            <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/kattalai_archanai/add"><button type="button" class="btn bg-deep-purple waves-effect"><?php echo $lang->add; ?></button></a></div></div>
                        </div>
					<?php } ?>
                        <div class="body">
                                            ...
                                            <?php if($permission['view'] == 1 ||  $permission['edit'] == 1 ||  $permission['delete_p'] == 1) { ?>
                                                <td style="width: 10%;">
                                                    <?php if($permission['view'] == 1) { ?>
                                                        <a class="btn btn-success btn-rad" title="View" href="<?= base_url()?>/kattalai_archanai/view/<?php echo $row['id'];?>"><i class="material-icons">&#xE417;</i></a>
                                                    <?php }
													if($permission['edit'] == 1) { ?> 
                                                        <a class="btn btn-primary btn-rad" title="Edit" href="<?= base_url()?>/kattalai_archanai/edit/<?php echo $row['id'];?>"><i class="material-icons">&#xE3C9;</i></a>
                                                    <?php }
...
<script>
    function confirm_modal(id)
    {
		//alert(id)
        $.ajax({
            url: "<?php echo base_url();?>/kattalai_archanai/del_check",
            type: "post",
            data: {id: id},
    ...
    function dedDel(id)
    {
        var act = "<?php echo base_url(); ?>/kattalai_archanai/delete/"+id;
