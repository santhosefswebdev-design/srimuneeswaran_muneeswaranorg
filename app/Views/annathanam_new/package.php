                    ...
                    <div class="header">
                        <div class="row">
                            ...
                            <div class="col-md-4" align="right"><a
                                    href="<?php echo base_url(); ?>/annathanam_new/add_package"><button type="button"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success btn-rad" title="View"
                                                    href="<?= base_url() ?>/annathanam_new/view_package/<?php echo $row['id']; ?>"><i
                                                        class="material-icons">&#xE417;</i></a>


                                                <a class="btn btn-primary btn-rad" title="Edit"
                                                    href="<?= base_url() ?>/annathanam_new/edit_package/<?php echo $row['id']; ?>"><i
                                                        class="material-icons">&#xE3C9;</i></a>

                                                <a class="btn btn-danger btn-rad" title="Delete"
                                                    href="javascript:void(0);" onclick="confirm_modal(<?php echo $row['id']; ?>)">
...
<script>
    function confirm_modal(id) {
        $.ajax({
            url: "<?php echo base_url(); ?>/annathanam_new/pack_del_check",
            type: "post",
            data: { id: id },
            success: function (data) {
                if (data == 0) {
                    ...
                    $("#spndeddelid").text("Are you sure to Delete this Package" + $("#pay" + id).attr("data-id") + "?");
                } else {
                    $('#del-modal').modal('show', { backdrop: 'static' });
                    $("#delmol").text("Sorry! We have used this package for bookings, So  you can't delete this Package");
                }
            }
        });
    }
    ...
    function dedDel(id) {
        var act = "<?php echo base_url(); ?>/annathanam_new/delete_package/" + id;
