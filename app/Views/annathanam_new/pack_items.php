                        ...
                        <div class="row">
                            <div class="col-md-8"><!--<h2>Hall</h2>--></div>
                                <div class="col-md-4" align="right"><a
                                    href="<?php echo base_url(); ?>/annathanam_new/add_pack_items"><button type="button" class="btn bg-deep-purple waves-effect">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success btn-rad" title="View"
                                                    href="<?= base_url() ?>/annathanam_new/view_pack_items/<?php echo $row['id']; ?>"><i
                                                        class="material-icons">&#xE417;</i></a>


                                                <a class="btn btn-primary btn-rad" title="Edit"
                                                    href="<?= base_url() ?>/annathanam_new/edit_pack_items/<?php echo $row['id']; ?>"><i
                                                        class="material-icons">&#xE3C9;</i></a>
