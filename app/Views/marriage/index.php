...
<section class="content">
    <div class="container-fluid">
        ...
        <h2>Member<small> Marriage Registration / <b>List</b></small></h2>
        </div>
        <!-- Basic Examples -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/marriage/add"><button type="button" class="btn bg-deep-purple waves-effect">Add</button></a></div></div>
                    </div>
                    <div class="body">
								...
								<table class="table table-bordered table-striped table-hover dataTable" id="datatables">
									<thead>
										<tr>
											...
											<th>Name of Bride</th>
											<th>Name of Groom</th>
											<th>Date of Intended Marriage</th>
