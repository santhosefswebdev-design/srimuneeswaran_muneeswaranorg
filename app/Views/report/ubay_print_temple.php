...
.unpaid_text { color:orangered; font-weight:600; }
.cancel_text { color:red; font-weight:600; }
.unpaid_text1 { color:blue; font-weight:600; }
</style>
...
<tr><td colspan="2">
    ...
    <p style="text-align:left; font-size:16px; margin:5px 0px;"><?php echo $_SESSION['address1']; ?>, <br><?php echo $_SESSION['address2']; ?>
	...
	<tr>
		...
		<td><?php if ($row['booking_status'] == 3) {
			...
			if (empty($row['paid_amount']) || $row['paid_amount'] == 0) {
				echo '<span class="unpaid_text">Only Booking</span>';
			} elseif ($balance_amount > 0) {
				echo '<span class="unpaid_text1">Partially Paid</span>';
			} else {
