...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Prasadam Group<small>Prasadam / <b>Add Prasadam Group </b></small></h2>
        </div>
        <!-- Basic Examples -->
                    ...
                    <div class="header">
                        <div class="row">
                            ...
                            <div class="col-md-4" align="right"><a
                                    href="<?php echo base_url(); ?>/report/prasadam_group"><button type="button"
                                        class="btn bg-deep-purple waves-effect">List</button></a></div>
                        </div>
                    </div>
                    <form action="<?php echo base_url(); ?>/report/prasadam_group_save" method="POST">
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text"  class="form-control" name="slot_name" value="<?php echo $data['group_name'];?>" <?php echo $readonly; ?>>
