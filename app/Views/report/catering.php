...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Catering <?php echo $lang->report; ?> <small><b>Catering <?php echo $lang->report; ?></b></small></h2>
        </div>
        <!-- Basic Examples -->
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                        <div class="body">
                        <form action="<?php echo base_url(); ?>/report/print_cateringreport" method="get" target="_blank">
                                <div class="container-fluid">
                                    <div class="row clearfix">
...
<script>
    $(document).ready(function(){        
        report = $('#datatables').DataTable({
            ...
            buttons: [],
            "ajax":{
                url: "<?php echo base_url(); ?>/report/catering_rep_ref",
                dataType: "json",
                type: "POST",
                data: function ( data ) {
                    data.fdt = $('#fdt').val();
