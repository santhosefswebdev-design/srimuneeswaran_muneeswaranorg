        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                        ...
                        <form action="<?php echo base_url(); ?>/report/print_deity_report" method="get" target="_blank">
                                <div class="container-fluid">
                                    <div class="row clearfix">
										...
										<div class="col-md-3 col-sm-3">
                                            ...
                                            <div class="col-md-3 col-sm-12" style="margin:0px;" align="right">                                    
    											...
    											<input name="pdf_deityreport" type="submit" class="btn btn-danger btn-lg waves-effect" id="pdf_deityreport" value="PDF">
    											<input name="excel_deityreport" type="submit" class="btn btn-success btn-lg waves-effect" id="pdf_deityreport" value="EXCEL">
    										</div>
                                        </div>
                                    </div>
                        </form>
