        ...
        <div class="container-fluid">
          <div class="row">
            <div class="block-header">
                <h2> HALL BOOKING <small>Booking / <b>Hall Booking List</b></small></h2>
            </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <div class="row"><div class="col-md-8 col-xs-6"><h2>Hall Booking List - <?= date("d-m-Y",strtotime($date)); ?></h2></div>
                            <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/booking/add_booking/<?= $date; ?>"><button type="button" class="btn bg-deep-purple waves-effect">New Booking</button></a></div></div>
                        </div>
                        <div class="body">
                                            ...
                                            <?php if($permission['view'] == 1 || $permission['edit'] == 1 ||  $permission['print'] == 1) { ?>                                            
												<td> 
													<?php if($permission['view'] == 1) { ?>
													    <a class="btn btn-success btn-rad" href="<?= base_url()?>/booking/view/<?php echo $row['id'];?>"><i class="material-icons">&#xE417;</i></a>
													<?php } if ($row['status']!=3) { 
                                                                if($permission['edit'] == 1 ){ ?>
													                <?php if($row['status'] == 1) { ?> <a class="btn btn-primary btn-rad" title="Edit" href="<?php echo base_url();?>/booking/edit_booking/<?= $row['id']; ?>"><i class="material-icons">&#xE3C9;</i></a> <?php } ?>
