    ...
    <div class="container-fluid">
        <div class="row">
            <div class="block-header">
                <h2> HALL BOOKING <small>Booking / <b>New Hall Booking</b></small></h2>
            </div>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <form>
                                  ...
                                  <div class="scroll products row" style="overflow-y:scroll; overflow-x:hidden; height: 250px;">
                                        <table class="table table-bordered ">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td><p></p><input style="left: 2%; opacity: 1;position: inherit;" type="checkbox"  <?= $disabled ?> name="timing[<?php echo $i++;?>]" value="<?php echo $row['id']; ?>"></td>
                                    ...
                                    <div class="row scroll" style="overflow-y:scroll; overflow-x:hidden; height: 200px;">
                                        <div class="table-responsive"><table class="table table-bordered" style="width:100%" id="package_table" style="height: 150px;">
                                            <thead>
                                                <tr>
                                                    <th width="60%">Name</th>
                                        ...
                                        <input type="hidden" id="pack_row_count" value="1">
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <form action="" method="post"></form>
                                            <div class="row" style="margin-top: 25px;">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" class="form-control reg_det" name="mobile" value="" required>
                    ...
                    success:function(data)
                    {
                        ...
                        if(obj.err != ''){
                            ...
                            $("#spndeddelid").text(obj.err);
								...
								{
									window.location.replace("<?php echo base_url();?>/booking/qrcode_generation/"+obj.id);
								}
