    ...
    <div class="container-fluid">
        <div class="row">
            <div class="block-header">
                <h2> HALL BOOKING <small>Booking / <b>Edit Hall Booking</b></small></h2>
            </div>
                                ...
                                <input type="hidden" name="hall_id" value="<?php echo $data['id'];?>">
                                  ...
                                  <div class="products row scroll" style="overflow-y:scroll; overflow-x:hidden; height: 250px;">
                                    ...
                                    <div class="row scroll" style="overflow-y:scroll; overflow-x:hidden; height: 200px;">
                                        <div class="table-responsive"><table style="width:100%;" class="table table-bordered" id="package_table" style="height: 150px;">
                                            <thead>
                                                <tr>
                                                    <th>Name</th>
                                                    <th>Total RM</th>
                                            ...
                                            <tbody>
                                                <?php $i=0; foreach($package_list as $row) { 
                                                    ...
                                                    <tr id="rmv_packrow<?= $i; ?>">
                                                        ...
                                                        <td style="width: 8%;"><a class="btn btn-danger btn-rad" onclick="rmv_pack(<?= $i++; ?>)"  style="width: 60%;"><i class="material-icons"></i></a></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table></div>
                                            ...
                                            <tbody>
                                                <?php $i=0; foreach($pay_details as $row) {?>
                                                    <tr id="rmv_payrow<?= $i; ?>">
                                                        ...
                                                        <td style="width: 8%;"><a class="btn btn-danger btn-rad" data-id="<?php echo $row['id']; ?>" id="<?php echo 'pay_id_'.$i; ?>"  onclick="rmv_pay(<?= $i++;?>)"  style="width: 60%;"><i class="material-icons"></i></a></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table></div>
                                            ...
                                            <div class="row" style="margin-top: 25px;">
                                                ...
                                                <div class="col-sm-3 col-md-3 col-xs-3">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="btn btn-success btn-lg " id="save">Save</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
