        ...
        <table style="width:100%;" border="0">
            <thead>
                <tr style="border-bottom:1px solid black;">
                    <th style="width: 20%; padding: 10px 0;" align="left">A/C No</th>
                    <th style="width: 60%; padding: 10px 0;" align="left">Description</th>
                    <th style="width: 10%;text-align:right; padding: 10px 0;" align="right">Debit</th>
                    <th style="width: 10%;text-align:right; padding: 10px 0;" align="right">Credit</th>
                </tr>
            </thead>
            <tbody>
