    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <div class="row"><div class="col-md-3"><h2>Consolidate Balance Sheet</h2></div>
                        <div class="col-md-9">
							<?php
                    ...
                    <div class="body">
                        ...
                        <form action="<?php echo base_url();?>/balance_sheet" method="post" style="margin-top:15px;">
                            ...
                            <form style="display: none;" target="_blank" id="print_sheet" action="<?php echo base_url();?>/balance_sheet/print_consolidate_balancesheet" method="post">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table_wrapper" style="width:100%;">
                            <tr>
                                ...
                                ?>
                                <th style="text-align: right;" class="thead"><?php echo $job_code['job_code']; ?></th>
                                <?php
                                    }
                                }
                                ?>
