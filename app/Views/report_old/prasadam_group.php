                    ...
                    <div class="header">
                        <div class="row">
                            ...
                            <div class="col-md-4" align="right"><a
                                    href="<?php echo base_url(); ?>/report/add_prasadam_group"><button type="button"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success btn-rad" title="View"
                                                    href="<?= base_url() ?>/report/view_prasadam_group/<?php echo $row['id']; ?>"><i
                                                        class="material-icons">&#xE417;</i></a>


                                                <a class="btn btn-primary btn-rad" title="Edit"
                                                    href="<?= base_url() ?>/report/edit_prasadam_group/<?php echo $row['id']; ?>"><i
                                                        class="material-icons">&#xE3C9;</i></a>
