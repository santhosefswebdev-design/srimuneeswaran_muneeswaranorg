        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-4" style="text-align:right">
                <a href="<?php echo base_url(); ?>/cemeteryreg/draft_list"><button type="button" class="btn btn-primary">List</button></a>
            </div>
            <p style="margin:0px;">&nbsp;</p>
            </div>
            <div class="row">
				<div class="col-md-12 card" style="padding:20px; background:#FFF !important;"> 
					<form action="<?php echo base_url(); ?>/cemeteryreg/update_draft_register" method="POST" enctype="multipart/form-data">
