                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 5%;">
                                                <?php
                                                if($row['special_time_status'] == 1 && $row['payment_status'] == 2)
                                                {
                                                ?>
                                                <label style="background: #FF9800;padding: 7px 10px;color: #fff;font-weight: bold;">Paid</label>
                                                <?php
                                                }
                                                if($row['special_time_status'] == 1 && $row['payment_status'] == 3)
                                                {
                                                ?>
                                                <label style="background: #F44336;padding: 7px 10px;color: #fff;font-weight: bold;">Failed</label>
                                                <?php
                                                }
                                                if($row['special_time_status'] == 1 && $row['payment_status'] == 1)
                                                {
                                                ?>
                                                <a href="<?= base_url()?>/IpayOnlineCemetery/payment_process/<?php echo $row['id'];?>" target="_blank" class="btn btn-primary" style="padding: 5px 10px;font-size: 12px;text-transform: capitalize;font-weight: bold;">Pay Now</a>
                                                <a class="btn btn-success btn-rad" href="<?= base_url()?>/cemeteryreg/edit/<?php echo $row['id'];?>" style="padding: 4px 10px;font-size: 12px;text-transform: capitalize;font-weight: bold;"><i class="fa fa-edit"></i></a>
                                                <?php
                                                }
                                                ?>
                                                
                                                <!--a target="_blank" title="PRINT" class="btn btn-primary btn-rad" href="<?= base_url()?>/cemeteryreg/cemetery_reg_print/<?php echo $row['id'];?>" ><i class="fa fa-print"></i></a-->
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
