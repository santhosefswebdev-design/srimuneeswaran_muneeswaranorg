                                            ...
                                            <td>
                                              <?php 
												if($row['draft_status'] == 'draft'){
													echo "<span class='alert-info' style='padding: 5px 10px;font-weight:bold;'>DRAFT</span>";
												}else{
												  if($row['payment_status'] == 1)
												  {
													echo "<span class='alert-warning' style='padding: 5px 10px;font-weight:bold;'>PENDING</span>";
												  }elseif($row['payment_status'] == 2){
													echo "<span class='alert-success' style='padding: 5px 10px;font-weight:bold;'>APPROVED</span>";
												  }elseif($row['payment_status'] == 3){
													echo "<span class='alert-danger' style='padding: 5px 10px;font-weight:bold;'>REJECTED</span>";
												  }
												}
                                              ?>
                                            </td>
