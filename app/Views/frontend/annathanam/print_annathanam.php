...
<table align="center" width="100%">
		...
		<td colspan="2">
			<table border="1" style="width:100%" align="center">
				...
				<tr>
					...
					<td>
						<?php echo !empty($ricecategory['name_eng']) ? $ricecategory['name_eng'] . " - " . $ricecategory['name_tamil'] : ""; ?>
					</td>
					<th align="left">Kurma </th>
					<td>
						<?php echo !empty($kurumatype['name_eng']) ? $kurumatype['name_eng'] . " - " . $kurumatype['name_tamil'] : ""; ?>
					</td>
				</tr>
				<tr>
	...
	<tr>
		<td colspan="2">
			<h4 style="text-align:center;"> காய்கறி வகைகள் / TYPE OF SIDE DISHES </h4>
		</td>
	</tr>
	<tr>
		<td colspan="2">
