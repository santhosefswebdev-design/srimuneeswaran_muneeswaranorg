                                                ...
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <select class="form-control" name="group_filter" id="group_filter">
                                                            <option value="0"><?php echo $lang->select; ?> <?php echo $lang->group; ?></option>
                                                            <?php
                                ...
                                <table style="width:100%;" align="center" class="table table-striped dataTable">
									<thead>
										<tr>
											...
											<th style="width:35%;">Prasadam - quantity</th>
									...
									<tbody>
										...
										<tr>
											...
											<td><?php echo $row['prasadam_str']; ?></td>
                                            <td><?php echo $row['paid_amount']; ?></td>
											<td style="width: 12%;">
												<!-- <a class="btn btn-warning btn-rad" href="<?= base_url()?>/annathanam_counter/view_annathanam/<?php echo $row['id'];?>"><i class="fa fa-eye"></i></a> -->
												<a class="btn btn-primary btn-rad" href="<?= base_url()?>/prasadam_online/print_booking_report/<?php echo $row['id'];?>" target="_blank"><i class="fa fa-print"></i> </a>
												<!-- <a class="btn btn-danger btn-cancel btn-rad" title="Cancel" href="<?= base_url()?>/templeubayam/cancel/<?php echo $row['id'];?>" target="_blank"><i class="fa fa-times"></i> </a> -->
												<?php if ($row['amount'] - $row['paid_amount'] && $row['payment_type'] == "partial") { ?>
