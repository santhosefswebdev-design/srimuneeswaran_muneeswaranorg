                                ...
                                <div class="form-container card-body" align="center">
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <!-- <h4 style="margin-bottom:5px; margin-top:5px; color:#FFFFFF; background:#d4aa00;">Choose Any Packages for Pay</h4>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <table class="table table-bordered ">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input style="left: 2%; opacity: 1;position: inherit;" type="radio" class="ubayam_slot" name="pay_for" value="wedding">
                                                            Wedding
                                                        </td>
                                                        <td>
                                                            <input style="left: 2%; opacity: 1;position: inherit;" type="radio" class="ubayam_slot" name="pay_for" value="engagement">
                                                            Engagement
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <div class="section"><hr style="height: 1px; background: #33333336;">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <h3 style="margin-bottom:5px; margin-top:5px;">Abishegam Details</h3>
                                                    <label>Do you wish to add Abishegam for Event?</label>
                                                    ...
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <select class="form-control" id="abishegamDropdown" onchange="addAbishegamToTable()">
                                                                ...
                                                                <?php /* for ($i = 1; $i <= 15; $i++): ?>
                                                                        <option value="<?= 'Deity' . $i; ?>"><?= 'Deity' . $i; ?> - SGD 100</option>
                                                                <?php endfor;*/ ?>
                                                                <option>SRI KARPAGA VINAYAGAR</option>
                                        ...
                                        <div class="section"><hr style="height: 1px; background: #33333336;">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <label>Do you wish to add Homam for Event?</label>
                                                    <label><input type="radio" style="left: 2%; opacity: 1;position: inherit;" name="abishegam" value="yes" onclick="toggleHomamSelection(true)"> Yes</label>
                                                    <label><input type="radio" style="left: 2%; opacity: 1;position: inherit;" name="abishegam" value="no" onclick="toggleHomamSelection(false)"> No</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="scroll products row">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select class="form-control" id="add_one_addon_product">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select class="form-control" id="add_one_addon_deity">
                                                        <option value="">Select Deity</option>
                                                        <option value="Bhairavar">Bhairavar</option>
                                        ...
                                        <div class="col-sm-1">
                                            <div class="form-group form-float">
                                                <div class="form-line" style="border: none;">
                                                    <label id="pack_add_addon" class="btn btn-success" style="padding: 5px 12px !important;" type="button">Add</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <label>Do you wish to add Annathanam for Event?</label>
                                                <label>
                                                    <input type="radio" style="left: 2%; opacity: 1;position: inherit;" name="annathanam" value="yes" onclick="toggleAnnathanamSelection(true)"> Yes
                                                </label>
                                                <label>
                                                    <input type="radio" style="left: 2%; opacity: 1;position: inherit;" name="annathanam" value="no" onclick="toggleAnnathanamSelection(false)"> No
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div id="annathanamSelection" style="display:none;">
                                            <div class="col-sm-6">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <select class="form-control" id="annathanamDeityDropdown">
                                                            <option value="">Select Deity</option>
                                                            <option value="Muneeswarar">Muneeswarar</option>
                                                            <option value="Vinayagar">Vinayagar</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <select class="form-control" id="annathanamPackageDropdown">
                                                            <option value="">Select Meals Package</option>
                                                            <option value="Veg Meals">Veg Meals - 6 SGD</option>
                                                            <option value="Veg Biriyani">Veg Biriyani - 7 SGD</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>

                                            <!-- Table to display selected deities and packages -->
                                            <div class="table-responsive col-sm-12" style="margin-bottom: 40px">
                                                <table class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="25%">Deity Name</th>
                                                            <th width="15%">Quantity</th>
                                                            <th width="15%">Amount (SGD)</th>
                                                            <th width="10%">Action</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="selectedAnnathanamTable">
                                                    </tbody>
                                                </table>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <select class="form-control" id="add_one_addon">
                                                        ...
                                                        <option value="">Parking Services</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <ul class="payment1">
                                                    <li><input type="radio" name="payment_mode" id="cb1" value="1" />
                                                     ...
                                                     <li><input type="radio" name="payment_mode" id="cb3" value="nets_pay" />
                            <label for="cb3"><i class="mdi mdi-credit-card-outline"></i> Nets</label>
                          </li>
                           <li><input type="radio" name="payment_mode" id="cb4" value="pay_now" />
                                        <label for="cb4"><i class="mdi mdi-qrcode"></i> Pay Now</label>
                                        </li>
                                           <li><input type="radio" name="payment_mode" id="cb5" value="3" />
                                                        <label for="cb5"><i class="mdi mdi-checkbook"></i> Cheque</label>
                                                    </li>
                                                    <li><input type="radio" name="payment_mode" id="cb6" value="2" />
...
<script>
    // Function to populate the table based on the selected package
function populatePackageTable(packageType) {
    var packageTableBody = document.getElementById('package_table').getElementsByTagName('tbody')[0];
    packageTableBody.innerHTML = ''; // Clear existing rows

    var packageName, packageDescription, packageAmount;

    if (packageType === 'wedding') {
        packageName = 'Wedding Package';
        packageDescription = 'Wedding';
        packageAmount = '1000 SGD';
    } else if (packageType === 'engagement') {
        packageName = 'Engagement Package';
        packageDescription = 'Engagement';
        packageAmount = '800 SGD';
    }

    var row = packageTableBody.insertRow(-1);
    var cell1 = row.insertCell(0);
    var cell2 = row.insertCell(1);
    var cell3 = row.insertCell(2);
    var cell4 = row.insertCell(3);

    cell1.innerHTML = packageName;
    cell2.innerHTML = packageDescription;
    cell3.innerHTML = packageAmount;
    cell4.innerHTML = '<button class="btn btn-danger" onclick="removePackageRow(this)">X</button>';
}
...
document.querySelectorAll('input[name="pay_for"]').forEach(function(elem) {
    elem.addEventListener('change', function() {
        populatePackageTable(this.value);
    });
});


document.getElementById('pack_add_addon').addEventListener('click', function() {
    var product = document.getElementById('add_one_addon_product').value;
    var deity = document.getElementById('add_one_addon_deity').value;
    var productPrice = 0;

    if (product === 'Vadai') {
        productPrice = 2.5;
    } else if (product === 'Sakkarai Pongal') {
        productPrice = 3.0;
    }

    if (product && deity) {
        addItemToTable(product, deity, productPrice);
    } else {
        alert('Please select both product and deity');
    }
});

function addItemToTable(product, deity, productPrice) {
    var tableBody = document.getElementById('package_table_addon').getElementsByTagName('tbody')[0];
    ...
    cell2.innerHTML = deity;
    cell3.innerHTML = '<input type="number" class="form-control" name="quantity" value="1" min="1" onchange="updateTotal(this, ' + productPrice + ')">';
    cell4.innerHTML = productPrice.toFixed(2) + ' SGD';
    cell5.innerHTML = '<button class="btn btn-danger" onclick="removeTableRow(this)">X</button>';
...
function updateTotal(quantityInput, productPrice) {
    ...
    var totalCell = quantityInput.parentNode.nextSibling;
    var total = (qty * productPrice).toFixed(2) + ' SGD';
...
function updateRowCount() {
    var rowCount = document.getElementById('package_table_addon').getElementsByTagName('tbody')[0].getElementsByTagName('tr').length;
    document.getElementById('pack_row_count_addon').value = rowCount;
}

</script>

<script>
    let selectedAnnathanamItems = [];
let serialNo = 1;

function toggleAnnathanamSelection(show) {
    const selectionDiv = document.getElementById('annathanamSelection');
    if (show) {
        selectionDiv.style.display = 'block';
    } else {
        selectionDiv.style.display = 'none';
        selectedAnnathanamItems = [];
        serialNo = 1;
        updateTable();
    }
}

document.getElementById('annathanamPackageDropdown').addEventListener('change', function() {
    const deity = document.getElementById('annathanamDeityDropdown').value;
    const packageSelected = this.value;

    if (deity && packageSelected) {
        const amount = packageSelected === 'Veg Meals' ? 6 : 7;
        addItemToTable(packageSelected, deity, amount);
    } else {
        alert('Please select both Deity and Package.');
    }
});

function addItemToTable(packageName, deityName, amount) {
    const item = {
        serialNo: serialNo++,
    ...
    selectedAnnathanamItems.push(item);
    updateTable();
}

function updateTable() {
    const tableBody = document.getElementById('selectedAnnathanamTable');
    tableBody.innerHTML = '';

    selectedAnnathanamItems.forEach(item => {
        ...
        row.innerHTML = `
            ...
            <td>
                <input type="number" value="${item.quantity}" min="1" class="form-control" onchange="updateQuantity(${item.serialNo}, this.value)">
            </td>
            <td>${(item.quantity * item.amount).toFixed(2)} SGD</td>
            <td><button class="btn btn-danger" onclick="removeItem(${item.serialNo})">X</button></td>
        `;
...
function updateQuantity(serialNo, newQuantity) {
    const item = selectedAnnathanamItems.find(i => i.serialNo === serialNo);
    if (item) {
...
function removeItem(serialNo) {
    selectedAnnathanamItems = selectedAnnathanamItems.filter(i => i.serialNo !== serialNo);
    updateTable();
}
</script>
...
document.getElementById('pack_add_addon').addEventListener('click', function() {
    const addonName = document.getElementById('add_one_addon').value;
    const addonDescription = addonName;
    const quantity = document.getElementById('get_pack_amt_addon').value;
    
    if (addonName && quantity) {
        addAddonToTable(addonName, addonDescription, quantity);
    } else {
        alert('Please select an add-on and enter a valid quantity.');
    }
});

function addAddonToTable(addonName, addonDescription, quantity) {
    let amount;
    
    // Define prices for the add-ons
    if (addonName === 'Cleaning services') {
        amount = 50; // Example amount for cleaning services
    } else if (addonName === 'Parking Services') {
        amount = 20; // Example amount for parking services
    } else {
        amount = 0; // Default if none match
    }

    const total = amount * quantity;

    const addon = {
        serialNo: addonSerialNo++,
        name: addonName,
...
function updateAddonTable() {
    const tableBody = document.getElementById('package_table_addon').querySelector('tbody');
    tableBody.innerHTML = '';
    ...
    selectedAddons.forEach(addon => {
        ...
        row.innerHTML = `
            ...
            <td>
                <input type="number" value="${addon.quantity}" min="1" class="form-control" onchange="updateAddonQuantity(${addon.serialNo}, this.value)">
            </td>
            <td>${addon.total.toFixed(2)} SGD</td>
            <td><button class="btn btn-danger" onclick="removeAddon(${addon.serialNo})">X</button></td>
        `;
...
function updateAddonQuantity(serialNo, newQuantity) {
    const addon = selectedAddons.find(i => i.serialNo === serialNo);
    if (addon) {
        addon.quantity = newQuantity;
        addon.total = (addon.total / addon.quantity) * newQuantity;
        updateAddonTable();
    }
}

function removeAddon(serialNo) {
    selectedAddons = selectedAddons.filter(i => i.serialNo !== serialNo);
    updateAddonTable();
}
...
function addAbishegamToTable() {
    ...
    var amount = "66"; // Fixed amount as per each deity
...
function addHomamToTable() {
    ...
    var rowCount = table.rows.length;
    var deityName = select.options[select.selectedIndex].text.split(' - ')[0];
    var amount = "100"; // Fixed amount as per each deity
...
function addHomamToTable() {
    ...
    var rowCount = table.rows.length;
    var deityName = select.options[select.selectedIndex].text.split(' - ')[0];
    var amount = "371"; // Fixed amount as per each deity
