                    ...
                    <div class="row">
                        <div class="col-md-12 card" style="padding:10px;">
                            <form class="form" id="form" method="post">
                                <input type="hidden" name="dt111" id="ubhayam_date" class="form-control"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label" for="dt">Ubayam Date</label>
                                                                <input class="input1 form-control datepicker" type="text" id="dt"
                                                                    name="dt" autocomplete="off"
                                                                    value="<?php echo date('Y-m-d'); ?>"
                                                                    min="<?php echo date('Y-m-d'); ?>" max="<?php echo $booking_calendar_range_year; ?>">
                                                            </div>
                                                        </div>
        ...
        <script>
            ...
            function displayCart() {
                ...
                if (cartArray.length > 0) {
                    ...
                    var output = "";
                    output += "<tr>"
                        + "<th style='padding: 5px 10px;line-height: 20px;width:10%'>Date </th><td style='background: #fff;border: 1px solid #dee2e6;padding: 5px 10px;line-height: 20px;'>" + formatDate(cartArray[0].dt) + "</td>"
                        + "</tr>";
