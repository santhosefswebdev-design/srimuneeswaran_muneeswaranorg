        ...
        <div class="content-wrapper">
            ...
            <div class="row">
				<div class="col-md-12 card" style="padding:20px;"> 
					<form class="form" id="form" method="post" action="<?php echo base_url(); ?>/agent_profile/update_profile">
				            ...
				            <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control" autocomplete="off" value="<?php echo $data['name']; ?>" required>
                                        </div></div>
                                        <div class="col-sm-6">
                                            <div class="form-group"><label class="form-label">Email Address <span style="color: red;">*</span></label>
                                    ...
                                    <div class="row">    
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="city" id="city" class="form-control" autocomplete="off" value="<?php echo $data['city']; ?>" >
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label class="form-label">State</label>
                                                <input type="text" name="state" id="state" class="form-control" autocomplete="off" value="<?php echo $data['state']; ?>" >
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label class="form-label">Country</label>
                                                <input type="text" name="country" id="country" class="form-control" autocomplete="off" value="<?php echo $data['country']; ?>" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row"> 
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="zipcode" id="zipcode" class="form-control" autocomplete="off" value="<?php echo $data['country']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group"><label class="form-label">Mobile Number</label>
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <select class="form-control" name="phonecode" id="phonecode">
                                                            ...
                                                            if(!empty($phone_codes))
                                                            {
                                                                ...
                                                                {
                                                            ?>
                                                            <option value="<?php echo $phone_code['dailing_code']; ?>" <?php if($phone_code['dailing_code'] == $data['dailing_code']){ echo "selected";}?>><?php echo $phone_code['dailing_code']; ?></option>
                                                            <?php
                                                                }
                                                            }              
                                                            ?>
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="form-control" type="number" id="mobile" name="mobile" min="0" autocomplete="off" value="<?php echo $data['phoneno']; ?>" required>
                                                    </div>
                                                </div>
                        ...
                        <div class="container-fluid">
                            <div class="row"> 
                                <div class="col-sm-12" align="center" style="margin:0 auto;">                             
				                    <input type="submit" value="UPDATE" class="button button-white greensubmit" id="submit">
                                </div>
                            </div>
                         </div>
				    </form> 
