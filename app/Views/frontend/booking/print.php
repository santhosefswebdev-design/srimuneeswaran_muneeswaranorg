...
p{font-size: 10px;text-align: center;font-weight: 600;font-family: monospace;margin: 0px}
</style>
<?php
...
<h3 style="text-align: center;text-transform: uppercase;max-width: 80mm;margin: 5px 0;font-size: 13px;font-family: monospace;">Office Copy</h3>
<p style="border-bottom: 3px dotted #9E9E9E;max-width: 80mm;"></p>
...
<p><img src="<?php echo base_url(); ?>/uploads/main/<?php echo $temp_details['image']; ?>" style="width:70px;" align="center"></p>
<p style="font-size:13px;font-weight:bold;"><?php echo $temp_details['name']; ?></p>
<p><?php echo $temp_details['address1']; ?><?php if(!empty($temp_details['address1'])){ echo "</br>"; echo $temp_details['address2']; } ?></br>
<?php echo $temp_details['city'].'-'.$temp_details['postcode']; ?>, 
Tel: <?= $temp_details['telephone']; ?></p>
<hr>
<p style="text-align:center; font-size:13px;text-transform: uppercase;margin-bottom: 5px;"> <b>HALL BOOKING INVOICE </b></p>
...
<p style="border-bottom: 3px dotted #9E9E9E;max-width: 80mm;"></p>
<h3 style="text-align: center;text-transform: uppercase;max-width: 80mm;margin: 5px 0;font-size: 13px;font-family: monospace;">Customer Copy</h3>
<p style="border-bottom: 3px dotted #9E9E9E;max-width: 80mm;"></p>
<p style="max-width: 80mm;font-size: 11px;">ஓம் சக்தி</p>
<div style="max-width: 80mm;max-height: auto;font-weight: 600;font-family: monospace;">
<p><img src="<?php echo base_url(); ?>/uploads/main/<?php echo $temp_details['image']; ?>" style="width:70px;" align="center"></p>
