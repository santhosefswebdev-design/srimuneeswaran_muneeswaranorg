                        ...
                        <!--h5 class="pay_mode">Payment Mode</h5-->
                         <ul class="payment">
                          ...
                          <li><input type="radio" name="pay_method" id="cb3" value="nets_pay" />
                            <label for="cb3"><i class="mdi mdi-qrcode"></i> Nets</label>
                          </li>
                        </ul>
...
function displayCart() {
  ...
  else
  {
    for(var i in cartArray) {
      var shortame = cartArray[i].name.length > 25 
              ? cartArray[i].name.substring(0, 25) + '...' 
              : cartArray[i].name;
      ...
      + "<td style='width:42%'><input type='hidden' name='prasadam["+i+"][amt]' value='"+(Number(cartArray[i].price).toFixed(2))+"' ><span class='archa_name' style='text-transform:uppercase;'>" + shortame + "</span><br>" 
