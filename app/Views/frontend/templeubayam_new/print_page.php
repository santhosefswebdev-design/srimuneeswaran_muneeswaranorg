            ...
            <table class="table table-bordered table-striped table-hover">
                <tbody>
                    <tr>
                        ...
                        $<?php echo number_format($pay_details['amount'], 2); ?>
                        <?php #echo number_format($data['paid_amount'], 2);
                                    /*echo number_format($pay_details[0]['amount'], 2);*/    ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2">&nbsp;</td>
                        <td style="text-align: right;">
                        $ <?php echo number_format(($data['total_amount'] - $pay_details['amount']), 2); ?>
                        
                        <?php #echo number_format(($data['total_amount'] - $data['paid_amount']), 2); 
                                            /*echo number_format(($data['total_amount'] - $pay_details[0]['amount']), 2);*/?></td>
                    </tr>
                    <?php if($data['payment_status'] != 0 ){ ?>
                    <tr>
                        <td class="right-align" width="30%"><strong>Payment Mode</strong></td>
                        <td colspan="2">&nbsp;</td>
                        <td style="text-align: right;"><?php #echo number_format($data['paid_amount'], 2);
                                    /*echo $pay_details[0]['payment_mode_title'];*/   ?>
                            <?php echo $pay_details['payment_records'][0]['payment_mode_title'] ?? ''; ?>        
                                    </td>
                    </tr>
                    <?php } ?>
                </tbody>
