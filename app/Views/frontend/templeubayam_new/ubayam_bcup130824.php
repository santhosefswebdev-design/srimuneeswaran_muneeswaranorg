        ...
        <div class="form-group form-float">
            <div class="form-line">
                <select class="form-control" id="abishegamDropdown" onchange="addAbishegamToTable()">
                    ...
                    <?php /* for($i = 1; $i <= 15; $i++): ?>
                        <option value="<?= 'Deity'.$i; ?>"><?= 'Deity'.$i; ?> - SGD 66</option>
                    <?php endfor;*/ ?>
                                    ...
                                    <div class="scroll products row">
                                        ...
                                        <div class="col-sm-5 ">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <!--<label class="form-lable">Package Name</label>-->
                                                    <select class="form-control" id="add_one_addons">
                                                        <option value="">Select From</option> 
                                        ...
                                        <div class="col-sm-1 ">
                                            <div class="form-group form-float">
                                                <div class="form-line" style="border: none;">
                                                    <label onclick="addprasadamToTable()" id="pack_add_addon" class="btn btn-success" style="padding: 5px 12px !important;">Add</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered" style="width:100%" id="package_table_addon" style="height: 150px;">
                                                    ...
                                                    <tbody id="selectedprasadamTable">
            </tbody>
                                                </table>
                                            </div>
...
<div class="row">
        <div class="col-sm-12">
            ...
            <label><input type="radio" style="left: 2%; opacity: 1;position: inherit;" name="annathanam" value="yes" onclick="toggleAnnathanamSelection(true)"> Yes</label>
            <label><input type="radio" style="left: 2%; opacity: 1;position: inherit;" name="annathanam" value="no" onclick="toggleAnnathanamSelection(false)"> No</label>
        </div>
    </div>
    ...
    <div id="annathanamSelection" style="display:none;">
        ...
        <div class="col-sm-6">
            <div class="form-group form-float">
                <div class="form-line">
                    <select class="form-control" onchange="addAnnathanamToTable()">
                        <option value="">Select Meals Packages</option>
 ...
 <div class="scroll products row">
                    ...
                    <div class="col-sm-6 ">
                        ...
                        <option value="<?php echo $row['id']; ?>"><?php echo $row['name']; ?></option>
                    <?php } */ ?>
                    <option>Mee hoon (1kg)</option>
                    <option>Parivattam</option>
                </select>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-sm-4">
        <div class="form-group form-float">
            <div class="form-line">
                <input type="text" id="total_amt_down" class="form-control" readonly name="total_amt" value=0>
                ...
                <label class="form-label">Balance SGD</label>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <h4 style="margin-bottom:5px; margin-top:5px; color:#FFFFFF; background:#d4aa00;">
                                                    Total Amount</h4>
                                                <input type="number" min="0" step="any" id="total_amt_up"
                                                ...
                                                <ul class="payment1">
                                                    ...
                                                    <li><input type="radio" name="payment_mode" id="cb3" value="2" />
            ...
            function get_booking_ubhayam(date) {
                ...
                function payfor(pay_id) {
                    ...
                    $.ajax({
                        ...
                        dataType: "json",
                        success: function (data) {
                            $("#total_amt_up").val(Number(data.amt).toFixed(2));
                            $("#total_amt_down").val(Number(data.amt).toFixed(2));
                            $("#pack_amount").val(Number(data.amt).toFixed(2));
                            $("#packname").text(data.name);
                            $("#total_amt_up").prop("max", Number(data.amt).toFixed(2));
                            $("#total_amt_down").prop("max", Number(data.amt).toFixed(2));
                            ...
                            if (data.addons.length > 0) {
                                ...
                                var a_html = '<option value="">Vadai</option>';
                            }
...
function addAbishegamToTable() {
    ...
    var amt = 387;
    $("#total_amt_up").val(Number(amt).toFixed(2));
    $("#total_amt_down").val(Number(amt).toFixed(2));
    $("#total_amt_up").prop("max", Number(amt).toFixed(2));
    $("#total_amt_down").prop("max", Number(amt).toFixed(2));
}
...
function addprasadamToTable() {
    var table = document.getElementById('selectedprasadamTable');
    var rowCount = table.rows.length;
    var deityName = "Durgai";
    var desc = "Vadai";
    var amount = "35";
        var row = table.insertRow();
        var cell1 = row.insertCell(0);
        ...
        cell1.innerHTML = deityName;
        cell2.innerHTML = desc;
        cell3.innerHTML = 50;
        cell4.innerHTML = "SGD " + amount;
        cell5.innerHTML = '<button onclick="deleteHomam(this)" style="border: none; background: none; color: red;"><i class="fas fa-trash-alt">x</i></button>';
