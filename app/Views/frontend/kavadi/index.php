...
<style>
  ...
  table tr td { padding :10px; border:0; }
</style>
     ...
     <div class="row">
        <div class="col-sm-12">
           <div class="banner-heading">
              <h1 class="banner-title">Kavadi Registration</h1>
              <ol class="breadcrumb">
                 <li>Home</li>
                 <li><a href="#">Kavadi Registration</a></li>
              </ol>
           </div>
        </div>
     </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
          ...
          <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>/kavadi/store" >
            <div class="body">
