			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<!-- Popup Modal -->
						...
						<div class="col-md-12">
							<h3 style="text-align: center" >Catering Report</h3>
						</div><br>

						<div class="header1">
                            <form action="<?php echo base_url(); ?>/report_online/print_cateringreport" method="POST">
                                <div class="container-fluid">
                                    ...
                                    <div class="col-md-2 col-sm-4">
                                        ...
                                        <div class="col-md-1 col-sm-2" align="right"> 
                                            <input name="pdf_cateringreport" type="submit" class="btn btn-danger btn-lg waves-effect" id="pdf_cateringreport" value="PDF">
                                        </div>
                                        <div class="col-md-1 col-sm-2" align="right"> 
                                            <input name="excel_cateringreport" type="submit" class="btn btn-success btn-lg waves-effect" id="excel_cateringreport" value="EXCEL">
                                        </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" style="text-align: center;" id="repaymentModalLabel">Catering Repayment</h5>
...
<script>
	$(document).ready(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>/catering_counter/gtpaymentdata",
            data: {
                id: bookingId
            },
    ...
    $("#saveRepayment").click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>/catering_counter/save_repayment", 
            data: {
                date: date,
    ...
    $(document).on('click', '.btn-cancel', function(e) {
        ...
        if (confirm('Are you sure you want to cancel this booking?')) {
            $.ajax({
                url: "<?php echo base_url(); ?>/catering_counter/update_booking_status", 
                type: 'POST',
                data: {
                    id: bookingId,
                    status: 3
                ...
                success: function(response) {
                    ...
                    setTimeout(function() {
                        window.location.replace("<?php echo base_url(); ?>/report_online/catering_report");
                    }, 2000); 
                },
    ...
    $(document).ready(function(){        
        report = $('#datatables').DataTable({
            ...
            paging: false,
            "ajax":{
                url: "<?php echo base_url(); ?>/report_online/catering_rep_ref",
                dataType: "json",
                type: "POST",
                data: function ( data ) {
                    data.fdt = $('#fdt').val();
