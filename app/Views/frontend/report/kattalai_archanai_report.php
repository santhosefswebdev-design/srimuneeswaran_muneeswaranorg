          ...
          <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					...
					<!-- Popup Modal -->
						<div class="col-md-12">
							<h3 style="text-align: center" >Kattalai Archanai Report</h3>
						</div><br>

						<div class="header1">
						    <form action="<?php echo base_url(); ?>/report_online/print_kattalaireport" method="POST">
...
(
...

    {
        report = $('#datatables').DataTable({
            ...
            buttons: [],
            "ajax":{
                url: "<?php echo base_url(); ?>/report_online/kattalai_archanai_report_ref",
                dataType: "json",
                type: "POST",
