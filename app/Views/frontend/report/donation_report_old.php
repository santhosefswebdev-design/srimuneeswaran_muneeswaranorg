			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<!-- Popup Modal -->
						...
						<div class="header1">
                            <form action="<?php echo base_url(); ?>/report_online/donation_report" method="POST">
                                ...
                                <table style="width:100%;" align="center" class="table table-striped dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											...
											<td style="width: 12%;">
                                                <a class="btn btn-primary btn-rad" href="<?= base_url()?>/donation_online/print_report/<?php echo $row['id'];?>" target="_blank"><i class="fa fa-print"></i></a>          
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
