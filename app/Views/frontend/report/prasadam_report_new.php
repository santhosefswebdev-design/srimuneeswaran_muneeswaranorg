			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					...
					<!-- Popup Modal -->
						...
						<div class="header1">
						    <form action="<?php echo base_url(); ?>/report_online/print_prasadamreport" method="get" target="_blank">
            ...
            success: function(response) {
                ...
                if (response && response.list) {
                    ...
                    $.each(response.list, function(index, row) {
                        var prasadamDetails = row.prasadam_str ? row.prasadam_str : '';
                        var rowHtml = `
                            <tr>
                                <td>${index + 1}</td>
                                ...
                                <td style="width: 12%;">
                                    <a class="btn btn-primary btn-rad" href="<?= base_url()?>/prasadam_online/print_booking_report/${row.id}" target="_blank"><i class="fa fa-print"></i></a>
                                    ${row.amount - row.paid_amount && row.payment_type === "partial" ? 
                                      `<a class="btn btn-warning btn-payment btn-rad" title="Pay" href="<?= base_url()?>/annathanam_new/payment/${row.id}" target="_blank"><i class="fa fa-credit-card"></i></a>` : ''}
                                </td>
                            </tr>
                        `;
