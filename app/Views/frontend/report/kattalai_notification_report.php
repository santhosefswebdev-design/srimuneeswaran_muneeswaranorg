...
.text-red { background-color: #ff6347; } /* Tomato */
.text-green { background-color: #32cd32; } /* LimeGreen */
.text-blue { background-color: #1e90ff; } /* DodgerBlue */
.text-orange { background-color: #ffa500; } /* Orange */
</style>
  ...
  <div class="container-scroller">
          ...
          <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					...
					<!-- Popup Modal -->
						<div class="col-md-12">
							<h3 style="text-align: center" >Kattalai Notification Report</h3>
						</div><br>

						<div class="header1">
						    <!-- <form action="<?php echo base_url(); ?>/report_online/print_kattalai_gurukal_report" method="POST"> -->
                            <form action="<?php echo base_url(); ?>/report_online/kattalai_notification_ref" method="POST">
                            ...
                            <form id="printForm" action="<?php echo base_url(); ?>/report_online/print_notificationreport" method="POST" target="_blank">
    ...
    <thead>
        <tr>
            ...
            <th style="width:8%;">Start Date</th>
            <th style="width:8%;">End Date</th>
            <th style="width:15%;text-align:center;">Devotee Name</th>
            <th style="width:9%; text-align:center;">Types</th>
            <th style="">Deity Name</th>
            <th style="">Devotee Details</th>
            <!-- <th style="width:12%;">Payment Type</th>
            <th style="width:10%;">Amount</th>
            <th style="width:10%;">Paid Amount</th> -->
                ...
                <td>
                    <div class="<?php 
                        $status_classes = [
                            'COMPLETED' => 'text-red',
                            'ONGOING' => 'text-green',
                            'NOT STARTED' => 'text-blue',
                            'GOING TO COMPLETE' => 'text-orange'
                        ];
                        echo 'status-btn ' . ($status_classes[$row['Status']] ?? '');
                    ?>">
