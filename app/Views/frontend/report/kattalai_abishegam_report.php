          ...
          <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					...
					<!-- Popup Modal -->
						<div class="col-md-12">
							<h3 style="text-align: center" >Kattalai Abishegam Report</h3>
						</div><br>

						<div class="header1">
						    <form action="<?php echo base_url(); ?>/report_online/print_kattalai_abreport" method="POST">
                                <div class="container-fluid">
                                    <div class="row clearfix">
                                        ...
                                        <!--<div class="col-md-2" align="right">
                                            <a href="<?php //echo base_url(); ?>/report_online/kattalai_notification_ref/<?php //echo strtotime($from_date); ?>/<?php //echo strtotime($to_date); ?>"
                                                target="_blank"><button type="button"
                                                    class="btn btn-info btn-lg ar_btn">Notification Report</button></a>
										</div>
                                        <div class="col-md-2" align="right">
                                            <a href="<?php //echo base_url(); ?>/report_online/kattalai_gurukal_report_ref/<?php //echo strtotime($from_date); ?>/<?php //echo strtotime($to_date); ?>"
                                                target="_blank"><button type="button"
                                                    class="btn btn-info btn-lg ar_btn">Gurukal Report</button></a>
										</div>-->
								...
								<div class="body">			
                                    <div class="table-responsive col-md-12 det" align="center" style="background:#FFF; float:none;">
                                        <table style="width:100%;" align="center" class="table table-striped dataTable capitalize" id="datatables">
                                            <thead>
											    <tr>
													<th style="width:5%;">S.No</th>
													<th style="width:8%;  text-align:center;">Date</th>
                                                    <th style="width:8%;  text-align:center;">Invoice.No</th>
													<th style="width:15%; text-align:left;">Devotee Name</th>
													<th style="width:9%;  text-align:left;">Types</th>
													<th style="width:12%; text-align:left;">Payment Type</th>
													<th style="width:10%; text-align:right;">Amount($)</th>
													<th style="width:10%; text-align:right;">Paid Amount($)</th>
													<th style="width:10%;">Action</th>
                                                    <!-- <th style="width:10%;">Repayment</th> -->
												</tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['daytype']; ?></td>
                                                    <td><?php echo $row['payment_type']; ?></td>
													<td><?php echo $row['amount']; ?></td>
													<td><?php echo $row['paid_amount']; ?></td>
                                                    <td style="width: 12%;">
                                                        <a class="btn btn-primary btn-rad" href="<?= base_url()?>/kattalai_archanai_online/print_booking/<?php echo $row['id'];?>" target="_blank"><i class="fa fa-print"></i> </a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" style="text-align: center;" id="repaymentModalLabel">Kattalai Abishegam Repayment</h5>
...
(
...

    {
        report = $('#datatables').DataTable({
            ...
            buttons: [],
            "ajax":{
                url: "<?php echo base_url(); ?>/report_online/kattalai_abishegam_report_ref",
                dataType: "json",
                type: "POST",
