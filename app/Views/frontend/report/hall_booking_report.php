                                ...
                                <table style="width:100%;" align="center" class="table table-striped dataTable" id="datatables">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:8%;">Amount(S$)</th>
                                            <th style="width:8%;">Paid Amount(S$)</th>
                                            <th style="width:10%;">Status</th>
                                            <th style="width:10%;">Action</th>
                                            <th style="width:10%;">Admin Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td><b>(Deposit Amount ($): <span id="depositAmount"></span>)</b></td>
                            ...
                            <div class="modal fade" id="alert-modal_deposit" tabindex="-1" role="dialog" aria-labelledby="repaymentModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <table>
                                            <tr>
                                                <td align="center"><b>Deposit Amount: ($ <span id="deposit_repay"></span>)</b></td>
                                            </tr>
                                        </table>
                                        <div class="modal-body">
                                            <form id="repaymentForm">
                                                ...
                                                <div class="form-group">
                                                    <label for="paymentMode">Payment Mode</label>
                                                    <select class="form-control" id="RepaymentMode" name="re_payment_mode" required>
                                                        <?php foreach($payment_modes as $payment_mode) { ?>
                                                            <option value="<?php echo $payment_mode['id']; ?>"><?php echo $payment_mode['name']; ?></option>
                                                        <?php } ?>
                                                    </select>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#saveDeppayment").click(function(){
            ...
            var paymentMode = $("#RepaymentMode").val();
            var bookingId = $("#bookingId").val();
