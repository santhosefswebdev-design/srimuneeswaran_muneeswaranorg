														...
														<?php
															...
															<tr class="all_close" data-id="<?php echo $entrie_item['ledger_id']; ?>" id="remov<?php echo $j; ?>">
																...
																<td><input type="hidden" id="edit_ledgerid_<?php echo $j; ?>" style="text-align: center;" class="row_amt" name="entries[<?php echo $j; ?>][ledgerid]" value="<?php echo $entrie_item['ledger_id']; ?>">
																	<select class="form-control search_box" data-live-search="true" id="payment_credit_ac_new_<?php echo $j; ?>" onchange="edit_reselectledger(<?php echo $j; ?>,this.value)">
																	<option value="">Select debit a/c</option>
																	<?php
																...
																<td><input type="text" style="text-align: center;" class="row_tot" name="entries[<?php echo $j; ?>][amount]" id="tot_<?php echo $j; ?>" value="<?php echo $entrie_item['amount']; ?>" readonly></td>
	...
	$('#addcreditdetail').click(function(){
      ...
      //  var cnt = parseInt($("#pay_row_count").val());
        if(payment_credit_ac != '' && payment_amount != "0.00" && payment_amount != "0"){
			...
			text1 += '<td><input type="number" style="text-align: center;" class="row_tot" id="tot_'+i+'" name="entries['+i+'][amount]" value="'+amt+'" readonly></td>';
