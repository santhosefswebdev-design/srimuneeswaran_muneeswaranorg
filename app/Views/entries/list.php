                        ...
                        <div class="row">
                            ...
                            <?php if($permission['create_p'] == 1) { ?>
                                <div class="col-md-8" align="right">
                                    <a href="<?php echo base_url(); ?>/entries/receipt_add"><button type="button" class="btn bg-deep-purple waves-effect">Receipt</button></a>
                                    <a href="<?php echo base_url(); ?>/entries/payment_add"><button type="button" class="btn bg-deep-purple waves-effect">Payment</button></a>
                                    <!-- <a href="<?php echo base_url(); ?>/entries/add_entries/3"><button type="button" class="btn bg-deep-purple waves-effect">Contra</button></a> -->
                                    <a href="<?php echo base_url(); ?>/entries/journal_add"><button type="button" class="btn bg-deep-purple waves-effect">Journal</button></a>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
