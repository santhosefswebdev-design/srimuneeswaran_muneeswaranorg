															...
															if(!empty($entrie_items))
															{
																...
																foreach($entrie_items as $entrie_item)
																{
																	...
																	<tr class="all_close" data-id="<?php echo $entrie_item['ledger_id']; ?>" id="remov<?php echo $j; ?>">
																		...
																		<td><input type="hidden" id="edit_ledgerid_<?php echo $j; ?>" style="text-align: center;" class="row_amt" name="entries[<?php echo $j; ?>][ledgerid]" value="<?php echo $entrie_item['ledger_id']; ?>">
																		...
																		<td><input type="number" style="text-align: center;" class="row_tot" name="entries[<?php echo $j; ?>][amount]" id="tot_<?php echo $j; ?>" value="<?php echo $entrie_item['amount']; ?>" readonly></td>
	...
	$('#adddebitdetail').click(function(){
      ...
      //  var cnt = parseInt($("#pay_row_count").val());
        if(receipt_debit_ac != '' && receipt_amount != "0.00" && receipt_amount != "0"){
			...
			text1 += '<td><input type="hidden" id="ledgerid_'+i+'" style="text-align: center;" class="row_amt" name="entries['+i+'][ledgerid]" value="'+debit_ac+'"><select class="form-control search_box" data-live-search="true" id="receipt_debit_ac_new_'+i+'" onchange="reselectledger('+i+',this.value)"><option value="">Select credit a/c</option><?php
			...
			text1 += '<td><input type="number" style="text-align: center;" class="row_tot" name="entries['+i+'][amount]" id="tot_'+i+'" value="'+amt+'" readonly></td>';
