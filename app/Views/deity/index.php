                        ...
                        <div class="row">
                            <div class="col-md-8"><!--<h2>Hall</h2>--></div>
                                <div class="col-md-4" align="right"><a
                                    href="<?php echo base_url(); ?>/deity/add_deity"><button type="button" class="btn bg-deep-purple waves-effect">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success btn-rad" title="View"
                                                    href="<?= base_url() ?>/deity/view_deity/<?php echo $row['id']; ?>"><i
                                                        class="material-icons">&#xE417;</i></a>


                                                <a class="btn btn-primary btn-rad" title="Edit"
                                                    href="<?= base_url() ?>/deity/edit_deity/<?php echo $row['id']; ?>"><i
                                                        class="material-icons">&#xE3C9;</i></a>
...
<script>
    ...
    function dedDel(id) {
        var act = "<?php echo base_url(); ?>/deity/delete_deity/" + id;
