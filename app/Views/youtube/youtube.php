<section class="content">
        <div class="container-fluid">
            ...
            <h2>Youtube<small>Youtube / <b>Youtube Url</b></small></h2>
            </div>
            <!-- Basic Examples -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="header">
                            ...
                            <!-- <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/youtube/add_youtube"><button type="button" class="btn bg-deep-purple waves-effect">Add</button></a></div></div> -->
                        </div>
                        <?php } ?>
                        <div class="body">
                            ...
                            <?php } ?>
                            <form id="donation" action="<?php echo base_url(); ?>/youtube/save_youtube" method="POST" enctype="multipart/form-data">
                            <div class="col-sm-3">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text"  class="form-control" name="title" value="<?php echo $data['title'];?>" <?php echo $readonly; ?>>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text"  class="form-control" name="url" value="<?php echo $data['url'];?>" <?php echo $readonly; ?>>
                            ...
                            <div class="table-responsive col-md-12 det" style="background:#FFF; float:none;">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tr>
                                        <td><?php echo $i++; ?></td>
                                        <td id="title<?= $row['id']; ?>" data-id="<?= $row['title'];?>"><?php echo $row['title']; ?></td>
                                        <td><?php echo $row['description']; ?></td>
                                        <td><?php echo $row['url']; ?></td>
                                        
                                        <td>
                                        	
                                                    <a class="btn btn-success btn-rad" title="View" href="<?= base_url()?>/youtube/view_youtube/<?php echo $row['id'];?>"><i class="material-icons">&#xE417;</i></a>
                                                
                                                 
                                                    <a class="btn btn-primary btn-rad" title="Edit" href="<?= base_url()?>/youtube/edit_youtube/<?php echo $row['id'];?>"><i class="material-icons">&#xE3C9;</i></a>
                ...
                <div class="modal-content">
                    <div class="modal-body p-4">
                        <div class="text-center">
                            ...
                            <h4 class="mt-2">Delete Donation Setting</h4>
                            <table>
    ...
    <script>
        function validations(){
            $.ajax({
                type:"POST",
                url: "<?php echo base_url(); ?>/youtube/youtube_validation",
    ...
    {
        $.ajax({
            url: "<?php echo base_url();?>/youtube/del_don_check",
            type: "post",
            data: {id: id},
            success:function(data){
                if(data == 0){
                    ...
                    $("#spndeddelid").text("Are you sure to Delete "+$("#title"+id).attr("data-id") + "?" );
                }else{
    ...
    function dedDel(id)
    {
        var act = "<?php echo base_url(); ?>/youtube/delete_youtube/"+id;
