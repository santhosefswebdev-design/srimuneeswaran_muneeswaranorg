...
<head>
  ...
  <style>
    ...
    .clr-double {
      ...
      -webkit-text-fill-color: rgb(188 22 19);
    ...
    .h-bday {
      ...
      font-weight: 900;
      color: rgb(15 14 14);
      -webkit-text-fill-color: rgb(218 238 7);
      /* Will override color (regardless of order) */
    ...
    <div class="demo-wrap text-center mt-3">
      ...
      <div class="demo-content row">
        <div class="col">
          ...
          <div>
            <h2 style="color: rgb(214 46 10);; font-weight: 800 font-style: italic">அருள்மிகு இராஜமாரியம்மன் தேவஸ்தானம்
            </h2>
          ...
          <div>
            <p class="clr-blue" style="margin-right:45rem ;"><strong>To MR. V.RAJASELAN A/L VADIVALOO,</strong></p>
          ...
          <div>
            <p class="clr-blue">Wishing you a </p><span><h2 class="h-bday text-bold">Happy Birthday</h2></span><p class="clr-blue">, a wonderful year and success in all you do.</p>
