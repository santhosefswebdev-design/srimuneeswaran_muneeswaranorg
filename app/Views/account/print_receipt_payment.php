...
<tr><td colspan="2"><h2 style="text-align:center;">Statement of Receipt &amp; Payment Report <?php echo date("d/m/Y", strtotime($sdate)).' - '.date("d/m/Y", strtotime($edate)); ?></h2></td></tr>
<tr><td colspan="2">
    ...
    <thead>
        <tr>
            ...
            if($type_id == 1){
            ?>
            <th align="left">Receipts (RM)</th>
            <?php
            }
            if($type_id == 2){
            ?>
            <th align="left">Payments (RM)</th>
            <?php
            }
            if($type_id == 3){
            ?>
    ...
    <tfoot >
        <tr>
            ...
            if($type_id == 1){
            ?>
            <th align="right"><?php echo number_format($total_receipt, '2','.',''); ?></th>
            <?php
            }
            if($type_id == 2){
            ?>
            <th align="right"><?php echo number_format($total_payment, '2','.',''); ?></th>
            <?php
            }
            if($type_id == 3){
            ?>
