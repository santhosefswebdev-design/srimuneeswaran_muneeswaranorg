            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/account/funds"><button type="button" class="btn bg-deep-purple waves-effect">List</button></a></div></div>
                    </div>
                    <form action="<?php echo base_url(); ?>/account/save_funds" method="POST" enctype="multipart/form-data">
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text"  class="form-control" name="code" value="<?php echo $data['code'];?>" <?php echo $readonly; ?>>
