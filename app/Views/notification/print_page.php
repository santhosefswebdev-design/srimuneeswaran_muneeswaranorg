...
<tr style="background-color: black;"> 
	<td style="padding-left: 4%;color: #d8b01d;"><h5 style="margin: 5px;"><?php echo $_SESSION['site_title']; ?></h5></td>
	<td style="padding-left: 4%;color: #d8b01d;"><img src="<?php echo base_url(); ?>/uploads/main/<?php echo $_SESSION['logo_img']; ?>" align="center" style="width:40px; display:block; border-radius: 50%;" align="left" /></td>
</tr>
...
<tr><td colspan="2">
	...
	<tr>
		<td colspan="2" class="mem_dets">
			<?php echo $_SESSION['address1']; ?>,<?php echo $_SESSION['address2']; ?>, <?php echo $_SESSION['city']; ?> - <?php echo $_SESSION['postcode']; ?>
		</td>
	</tr>
    </table>
</td></tr>
