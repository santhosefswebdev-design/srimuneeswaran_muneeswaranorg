		...
		<div class="table-responsive col-md-12" style="background:#FFF; float:none;margin-bottom:0px;">
            <table class="table table-bordered table-striped table-hover">
				...
				<tr>
                    ...
                    <td style="text-align: center;">
                        Event Name: <?php echo $packages['name']; ?>
                    </td>
                </tr>
				<!-- <tr>
                    <td style="text-align: center;">
                ...
                <tbody>
                    ...
                    <?php if(!empty($annathanam)){ ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">$<?php echo $row['no_of_pax'] * $row['amount']; ?></td>
                        </tr>
						<?php } ?>
					<?php } ?>
					...
					<?php if(!empty($annathanam_addons)){ ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">$<?php echo $row['quantity'] * $row['item_amount']; ?></td>
                        </tr>
						<?php } ?>
					<?php } ?>
