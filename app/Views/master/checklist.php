<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Checklist<small>Booking / <b>Vendor Checklist</b></small></h2>
        </div>
        <!-- Basic Examples -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="header">
                        ...
                        <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/master/add_checklist"><button type="button" class="btn bg-deep-purple waves-effect">Add</button></a></div></div>
                    </div>
                    <?php } ?>
                    <div class="body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	<?php if($permission['view'] == 1) { ?>
                                                    <a class="btn btn-success btn-rad" title="View" href="<?= base_url()?>/master/view_checklist/<?php echo $row['id'];?>"><i class="material-icons">&#xE417;</i></a>
                                                <?php }  if($permission['edit'] == 1) { ?>
                                                    <a class="btn btn-primary btn-rad" title="Edit" href="<?= base_url()?>/master/edit_checklist/<?php echo $row['id'];?>"><i class="material-icons">&#xE3C9;</i></a>
                                                <?php }  ?>
                                       </td>
                                       <?php } ?>
                                    </tr>
                ...
                <div class="modal-content">
                    <div class="modal-body p-4">
                        <div class="text-center">
                            ...
                            <h4 class="mt-2">Delete Service</h4>
                            <table>
