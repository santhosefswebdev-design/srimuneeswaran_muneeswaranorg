...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2> Master<small>Payment Option / <b>Payment Option List</b></small></h2>
            </div>
            <!-- Basic Examples -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<?php //if($permission['create_p'] == 1) { ?>
                        <div class="header">
                            ...
                            <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/master/add_payment_option"><button type="button" class="btn bg-deep-purple waves-effect">Add</button></button></a></div></div>
                        </div>
					<?php //} ?>
                        <div class="body">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a class="btn btn-primary btn-rad" title="Edit" href="<?= base_url()?>/master/edit_payment_option/<?php echo $row['id'];?>"><i class="material-icons">&#xE3C9;</i></a>
