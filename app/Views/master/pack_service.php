                    ...
                    <div class="header">
                        <div class="row">
                            ...
                            <div class="col-md-4" align="right"><a
                                    href="<?php echo base_url(); ?>/master/add_pack_service"><button type="button"
                                ...
                                <tbody>
                                    ...
                                    foreach ($list as $row) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                if($row['service_type']==1) { echo "Hallbooking"; }
                                                else if($row['service_type']==2) { echo "Ubayam"; }
                                                else if($row['service_type']==3) { echo "Sannathi"; }
                                                else if($row['service_type']==4) { echo "Outdoor"; }
                                                ?>
                                            </td>
                                            <td>
                                                <?php echo $row['amount']; ?>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success btn-rad" title="View"
                                                    href="<?= base_url() ?>/master/view_pack_service/<?php echo $row['id']; ?>"><i
                                                        class="material-icons">&#xE417;</i></a>


                                                <a class="btn btn-primary btn-rad" title="Edit"
                                                    href="<?= base_url() ?>/master/edit_pack_service/<?php echo $row['id']; ?>"><i
                                                        class="material-icons">&#xE3C9;</i></a>
