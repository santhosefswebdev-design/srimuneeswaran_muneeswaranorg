...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>PRODUCT SETTING<small>Donation / <a href="#" target="_blank">Product Setting</a></small></h2>
        </div>
        <!-- Basic Examples -->
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <div class="row"><div class="col-md-8"><h2>Product</h2></div>
                        <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/master/product"><button type="button" class="btn bg-deep-purple waves-effect">List</button></a></div></div>
                    </div>
                    <form action="<?php echo base_url(); ?>/master/save_product" method="POST" enctype="multipart/form-data">
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <select class="form-control show-tick" name="stock_group">
                                        <option value="">-- Select Stock Group --</option>
                                        <?php foreach($stock as $st) { ?>
										<option value="<?php echo $st['id']; ?>" <?php if($data['stock_group'] == $st['id']){ echo "selected"; } ?>><?php echo $st['name']; ?></option>
                                        <?php } ?>
                                        </select>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="product_model" id="product_model" value="<?php echo $data['product_model'];?>" <?php echo $readonly; ?>>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text"  class="form-control" name="opening_stock" value="<?php echo $data['opening_stock'];?>" <?php echo $readonly; ?>>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text"  class="form-control" name="minimum_stock" id="minimum_stock" value="<?php echo $data['minimum_stock'];?>" <?php echo $readonly; ?>>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <select class="form-control show-tick" name="uom_id">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text"  class="form-control" name="price" value="<?php echo number_format($data['price'], '2','.',',');?>" <?php echo $readonly; ?>>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="file" name="product"  class="form-control" accept="image/png, image/jpeg, image/jpg" <?php echo $readonly; ?> />
                                    </div>
                                </div>
                            </div>
