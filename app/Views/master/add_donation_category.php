...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>DONATION CATEGORY<small>Donation / <b>Add Donation category</b></small></h2>
        </div>
        <!-- Basic Examples -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/master/donation_category"><button type="button" class="btn bg-deep-purple waves-effect">List</button></a></div></div>
                    </div>
                    <form action="<?php echo base_url(); ?>/master/save_donation_category" method="POST" enctype="multipart/form-data">
                    <div class="body">
								...
								<div class="form-group form-float">
									<div class="form-line">
										<select name="fund_id" id="fund_id" class="form-control">
											...
											if(count($funds) > 0){
												 foreach($funds as $dc){
													 echo '<option value="' . $dc['id'] . '"'. ($data['fund_id'] == $dc['id'] ? ' selected="selected"' : '') .'>' . $dc['name'] . '</option>';
												 }
											}else{
