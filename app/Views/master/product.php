<section class="content">
    <div class="container-fluid">
        ...
        <h2>PRODUCT SETTING<small>Donation / <b>Product Setting</b></small></h2>
        </div>
        <!-- Basic Examples -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<?php if($permission['create_p'] == 1) { ?>
                    <div class="header">
                        ...
                        <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/master/add_product"><button type="button" class="btn bg-deep-purple waves-effect">Add Product</button></a></div></div>
                    </div>
				<?php } ?>
                    <div class="body">
										...
										<?php if($permission['view'] == 1 ||  $permission['edit'] == 1 ||  $permission['delete_p'] == 1) { ?>
											<td align="center">
												<?php if($permission['view'] == 1) { ?>
													<a class="btn btn-success btn-rad" title="View" href="<?php echo base_url()?>/master/view_product/<?php echo $row['id'];?>"><i class="material-icons">&#xE417;</i></a>
												<?php }
												if($permission['edit'] == 1) { ?> 
                                                    <a class="btn btn-primary btn-rad" title="Edit" href="<?php echo base_url()?>/master/edit_product/<?php echo $row['id'];?>"><i class="material-icons">&#xE3C9;</i></a>
												<?php }
