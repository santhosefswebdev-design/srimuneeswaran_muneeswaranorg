<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>RENTAL<small>Rental / <b>Rental Type Setting</b></small></h2>
        </div>
        <!-- Basic Examples -->
                ...
                <div class="card">
                    ...
                    <div class="body">
                    	<?php if($_SESSION['succ'] != '') { ?>
                            ...
                            <?php } ?>
                        <form action="<?php echo base_url(); ?>/master/save_rental_type" method="POST">
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	<a class="btn btn-success btn-rad" title="View" href="<?= base_url()?>/master/view_rental_type/<?php echo $row['id'];?>"><i class="material-icons">&#xE417;</i></a>
                                            <a class="btn btn-primary btn-rad" title="Edit" href="<?= base_url()?>/master/edit_rental_type/<?php echo $row['id'];?>"><i class="material-icons">&#xE3C9;</i></a>
                ...
                <div class="modal-content">
                    <div class="modal-body p-4">
                        <div class="text-center">
                            ...
                            <h4 class="mt-2">Delete Rental Type</h4>
                            <table>
...
<script>
    ...
    function dedDel(id)
    {
        var act = "<?php echo base_url(); ?>/master/delete_rental_type/"+id;
