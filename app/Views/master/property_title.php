            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                	<!--<div class="header">
                        ...
                        <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/master/add_property_title"><button type="button" class="btn bg-deep-purple waves-effect">Add</button></a></div></div>
                    </div>-->
                    <div class="body">
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	<a class="btn btn-success btn-rad" title="View" href="<?= base_url()?>/master/view_property_title/<?php echo $row['id'];?>"><i class="material-icons">&#xE417;</i></a>
                                            <a class="btn btn-primary btn-rad" title="Edit" href="<?= base_url()?>/master/edit_property_title/<?php echo $row['id'];?>"><i class="material-icons">&#xE3C9;</i></a>
                ...
                <div class="modal-content">
                    <div class="modal-body p-4">
                        <div class="text-center">
                            ...
                            <h4 class="mt-2">Delete Property Title</h4>
                            <table>
...
<script>
    ...
    function dedDel(id)
    {
        var act = "<?php echo base_url(); ?>/master/delete_property_title/"+id;
