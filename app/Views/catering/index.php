...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2> Catering <small><b>List</b></small></h2>
            </div>
            <!-- Basic Examples -->
                    ...
                    <div class="card">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body p-4">
                                        <div class="text-center">
                                            ...
                                            <h4 class="mt-2">Delete Catering</h4>
                                            <table>
                        ...
                        <!--End Delete Form-->
							<div class="header">
								...
								<div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/catering/add_catering"><button type="button" class="btn bg-deep-purple waves-effect">Add Catering</button></a></div></div>
							</div>
                        <div class="body">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 12%;">
												<a class="btn btn-primary btn-rad" href="<?= base_url()?>/catering/print_page/<?php echo $row['id'];?>" target="_blank"><i class="material-icons">print</i> </a>
    ...
    $(document).ready(function(){
        $(".btn-payment").click(function(e){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>/catering/gtpaymentdata",
                data: {
                    id: bookingId
                },
        ...
        $("#saveRepayment").click(function(){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>/catering/save_repayment", 
                data: {
                    date: date,
    ...
    $('.btn-cancel').click(function(e) {
        ...
        if (confirm('Are you sure you want to cancel this booking?')) {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>/catering/update_booking_status", 
                type: 'POST',
                data: {
                    id: bookingId,
                    status: 3
