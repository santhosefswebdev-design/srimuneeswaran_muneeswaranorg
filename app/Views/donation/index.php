...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2> CASH DONATION<small>Donation / <b>Cash Donation</b></small></h2>
            </div>
            <!-- Basic Examples -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<?php if($permission['create_p'] == 1) { ?>
                        <div class="header">
                            ...
                            <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/donation/add"><button type="button" class="btn bg-deep-purple waves-effect">New Donation</button></a></div></div>
                        </div>
					<?php } ?>
                        <div class="body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 16%;">
                                                ...
                                                <a class="btn btn-success btn-rad" href="<?= base_url()?>/donation/view/<?php echo $row['id'];?>"><i class="material-icons">&#xE417;</i></a>
                                                <?php } if($permission['print'] == 1) {?>
												<a class="btn btn-primary btn-rad" href="<?= base_url()?>/donation/print_page/<?php echo $row['id'];?>" target="_blank"><i class="material-icons">&#xe8ad;</i></a>
                                                <?php } ?>
