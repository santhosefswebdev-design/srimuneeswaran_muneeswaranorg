...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2> MEMBER TYPE<small>Master / <b>Member Type</b></small></h2>
            </div>
            <!-- Basic Examples -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<?php if($permission['create_p'] == 1) { ?>
                        <div class="header">
                            ...
                            <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/member_type/add"><button type="button" class="btn bg-deep-purple waves-effect">Add</button></a></div></div>
                        </div>
					<?php } ?>
                        <div class="body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 16%;">
                                                ...
                                                <a class="btn btn-success btn-rad" href="<?= base_url()?>/member_type/view/<?php echo $row['id'];?>"><i class="material-icons">&#xE417;</i></a>
                                                <?php } if($permission['edit'] == 1) {?>
												<a class="btn btn-warning btn-rad" href="<?= base_url()?>/member_type/edit/<?php echo $row['id'];?>"><i class="material-icons">&#xE3C9;</i></a>
                                                <?php } ?>
