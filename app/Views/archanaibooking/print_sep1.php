...
<p><img src="<?php echo base_url(); ?>/uploads/main/<?php echo $_SESSION['logo_img']; ?>" style="width:70px;" align="center"></p>
...
<tr><td><?= $rasi_row[$key]['name']; ?></td>
<td><?= $rasi_row[$key]['rasi_name_tamil']; ?><br><?= $rasi_row[$key]['rasi_name_eng']; ?></td>
<td><?= $rasi_row[$key]['nat_name_tamil']; ?><br><?= $rasi_row[$key]['nat_name_eng']; ?></td></tr>
</table>
</div>
<br><br><br><br><br><br>
