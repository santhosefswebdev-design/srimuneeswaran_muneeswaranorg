...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2> Archanai Ticket Print<small>Archanai / <b>Archanai Ticket Print List</b></small></h2>
            </div>
            <!-- Basic Examples -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<?php if($permission['create_p'] == 1) { ?>
                        <div class="header">
                            ...
                            <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/archanai/add"><button type="button" class="btn bg-deep-purple waves-effect">Add</button></a></div></div>
                        </div>
					<?php } ?>
                        <div class="body">
                            ...
                            <?php } ?>
                            <form action="<?php echo base_url(); ?>/archanaibooking/ticket_print" method="POST">
                                <div class="container-fluid">
                                    <div class="row clearfix">
                                        <div class="col-md-2 col-sm-3">
                                            <div class="form-group form-float">
                                                <div class="form-line" id="bs_datepicker_container" >
                                                    <input type="date" name="fdt" id="fdt" class="form-control" value="<?php echo $from_date; ?>"  max="<?php echo $booking_calendar_range_year; ?>">
                                        ...
                                        <div class="col-md-2 col-sm-3">
                                            <div class="form-group form-float">
                                                <div class="form-line" id="bs_datepicker_container" >
                                                    <input type="date" name="tdt" id="tdt" class="form-control" value="<?php echo $to_date; ?>"  max="<?php echo $booking_calendar_range_year; ?>">
                                        ...
                                        <div class="col-md-2 col-sm-3">
                                            <div class="form-group form-float">                                        
                                                <button type="submit" class="btn btn-success btn-lg waves-effect" id="submit">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
