            ...
            <div class="row">
				<div class="col-md-12 card" style="padding:20px; background:#FFF !important;"> 
                    ...
                    <div class="body"> 
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $data['num']; ?>" required name="cemetery_application_no" readonly="readonly" value="<?php echo $max['max_num']; ?>" id="cemetery_application_no" >
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <input type="date" class="form-control" value="<?php echo $data['date']; ?>" required name="cemetery_date" id="cemetery_date" value="<?php echo date('Y-m-d'); ?>">
								...
								<div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focused">
                                            ...
                                            <input type="datetime-local" class="form-control" value="<?php echo $data['ash_collect_dete']; ?>" name="ash_collect_dete" id="ash_collect_dete">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <input type="text"  class="form-control" name="ash_collect_by" value="<?php echo $data['ash_collect_by']; ?>" id="ash_collect_by">
                        ...
                        <div class="row"><button class="btn btn-success" type="submit">Update</button>
                    </div>
                    </div>
                    </form> </div>
				</div>
