...
<tr><td>
    ...
    <td>New/<span style="font-size:12px">புதிது</span> : <?php echo $cemetery['nric_old']; ?></td></tr>
    <tr><td>F <?php if($cemetery['sex'] == 'Female') { ?> &#10004; <?php } ?></td>
    <td>Old/<span style="font-size:12px">பழைய</span> : <?php echo $cemetery['nric_new']; ?></td></tr>
...
<tr><td>
    ...
    <td style="width:50%"><p class="inline">Collected by / <span style="font-size:12px">பெற்றுக்கொண்டவர்</span></p><p class="inline" style="border-bottom:1px dotted #333333; width:120px; position:absolute;">&nbsp; <?php echo $cemetery['ash_collect_by']; ?></p></td></tr>
    <tr><td></td>
