                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <input type="text" class="form-control" name="cemetery_application_no" value="<?php echo $data['num']; ?>" readonly="readonly" value="<?php echo $max['max_num']; ?>" id="cemetery_application_no" >
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <input type="date" class="form-control" required name="cemetery_date" id="cemetery_date" value="<?php echo $data['date']; ?>" disabled>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <select name="slot_type" id="slot_type" class="form-control" disabled>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <input type="text"  class="form-control" required name="cemetery_name_deceased" id="cemetery_name_deceased" value="<?php echo $data['name_of_deceased']; ?>">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <input type="text" class="form-control" required name="cemetery_nationality" id="cemetery_nationality" value="<?php echo $data['nationality']; ?>">
								...
								<div class="col-sm-6">
									<div class="form-group form-float" style="margin: 2px;">
										<div class="form-line">
											...
											<input type="text"  class="form-control" name="management" id="management" value="<?php echo $data['management']; ?>">
