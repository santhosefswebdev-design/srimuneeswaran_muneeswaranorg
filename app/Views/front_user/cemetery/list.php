	  ...
	  <?php } ?>
        <div class="row">
          ...
          <div class="col-md-4" style="text-align:right">
            <a href="<?php echo base_url(); ?>/cemeteryreg/add"><button type="button" class="btn btn-primary">Add</button></a>
          </div>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 5%;">
                                                <a class="btn btn-success btn-rad" href="<?= base_url()?>/cemeteryreg/edit/<?php echo $row['id'];?>"><i class="fa fa-edit"></i></a>
