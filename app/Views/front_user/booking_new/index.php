				          ...
				          <div class="form-container" align="center"> 
                            ...
                            <div class="row">
                                    ...
                                    <div class="pack">
                                       <div class="row">
                                            <ul class="payment prod">
                                              ...
                                              <li>
                                                  <input type="checkbox" class="package_amt" name="pay_for[<?php echo $rj; ?>][pack_amt]" value="<?php echo $row['id']; ?>" id="pay_for<?php echo $row['id']; ?>" data-id="<?php echo $row['id']; ?>" />
                            	...
                            	<div class="col-md-4">
                                    ...
                                    <table class="show-cart1 package_cart" id="package_cart" style="width:100%;"></table>
...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="event_name">Event name <span style="color:red;">*</span></label>
                                <input class="input1 form-control" type="text" name="event_name" id="event_name" autocomplete="off">
                                <span id="error_msg"></span><input type="hidden" class="form-control" id="event_date" name="event_date" readonly value="<?php echo date('Y-m-d'); ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="name">Name <span style="color:red;">*</span></label>
                                <input class="input1 form-control" type="text" name="name" id="name" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="input1 form-control" type="text" name="address" id="address" autocomplete="off">
                            <span id="error_msg"></span></div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="city">City <span style="color:red;">*</span></label>
                                <input class="input1 form-control" type="text" name="city" id="city"  autocomplete="off">
                            <span id="error_msg"></span></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="input1 form-control" type="text" name="state" id="state"  autocomplete="off">
                            <span id="error_msg"></span></div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="city">Post Code <span style="color:red;">*</span></label>
                                <span id="error_msg"></span><input class="input1 form-control" type="text" name="postcode" id="postcode" maxlength="36" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="ic_num">IC No / Passport No <span style="color:red;">*</span></label>
                                <input class="input1 form-control" type="text" name="ic_num" id="ic_num" autocomplete="off">
                            <span id="error_msg"></span></div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label" for="email">Email <span style="color:red;">*</span></label>
                                <input class="input1 form-control email" type="email" name="email" id="email" maxlength="256" autocomplete="off">
  ...
  <script>  
        ...
        setTimeout(function(){
            ...
            $(".package_amt").each(function(){
                ...
                if (this.checked) {
                    var cnt = $(this).val();
                    $.ajax({
                        url: "<?php echo base_url()?>/booking_cust/getpack_amt",
                        type:"POST",
                        data: {id: cnt},
    ...
    $('#ar_add_btn').click(function(event) {
        ...
        if(event_name != "" && name !="" && phonecode !="" && mobile !="" && email !="")
        {
            $("#myModal").modal("hide");
    ...
    if(events.length===0) {
        ...
        for(var i=0; i<events.length; i++) {
            ...
            else
            {
                ...
                var event_count = $("<div class='event-name'> <a class='btn btn-primary book_sts' style='font-size: 13px;font-weight: bold;padding: 5px;' title='Print' href='"+url+"/booking_cust/list_booking_print/"+events[i]["event_id"]+"' target='_blank'>Print</a></div>");
    ...
    $("#ok-button").unbind().click({date: event.data.date}, function() {
       ...
       // return;
        ...
        if(timings === 0) {
            ...
            $.ajax({
				type:"POST",
				url: "<?php echo base_url();?>/booking_cust/save_booking",
				data: $("form").serialize(),
                beforeSend: function() {    
                    $("#loader").show();
                },
				success:function(data)
				{
					...
					if(obj.err != ''){
						...
						window.open("<?php echo base_url();?>/booking_cust/payment_process/" + obj.id, "_blank", "width=680,height=500");
...
function loadbookingslots(date)
{
    $.ajax({
        type:"POST",
        url: "<?php echo base_url();?>/booking_cust/loadbookingslots",
