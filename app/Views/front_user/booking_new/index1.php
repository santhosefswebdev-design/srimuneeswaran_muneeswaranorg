                                ...
                                <div class="row">
                                        ...
                                        <div class="pack">
                                            <div class="row">
                                                ...
                                                <ul class="payment prod">
                                                  ...
                                                  <li>
                                                      <input type="checkbox" class="package_amt" name="pay_for" value="<?php echo $row['id']; ?>" id="pay_for<?php echo $row['id']; ?>" />
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="city">Postal Code</label>
                                                        ...
                                                        <div class="col-md-4">
                                                            <select class="form-control" name="phonecode" id="phonecode">
                                                                ...
                                                                if(!empty($phone_codes))
                                                                {
                                                                    ...
                                                                    {
                                                                ?>
                                                                <option value="<?php echo $phone_code['dailing_code']; ?>"><?php echo $phone_code['dailing_code']; ?></option>
                                                                <?php
                                                                    }
                                                                }              
                                                                ?>
                                    ...
                                    <div class="col-md-6">
                                        <h4 style="margin-bottom:5px; margin-top:5px; color:#FFFFFF; background:#d4aa00;">Booking Slot</h4>
                                        <div class="project">
                                            <div class="boxes" id="booking_slot">
                                            <div class="box">
                                              <div>
                                                  <input type="checkbox" class="slot" name="timing[]" value="1" id="timing1" >
                                              </div>
                                              <label for="timing1" style="cursor: no-drop;">
                                                  <p id="timing1">Slot 1<br>6:00 AM - 9:00 AM</p>
                                              </label>
                                          </div>
                                          <div class="box">
                                              <div>
                                                  <input type="checkbox" class="slot" name="timing[]" value="2" id="timing2" style="">
                                              </div>
                                              <label for="timing2" style="">
                                                  <p id="timing2">Slot 2<br>9:00 AM - 12:00 PM</p>
                                              </label>
                                          </div>
                                          <div class="box">
                                              <div>
                                                  <input type="checkbox" class="slot" name="timing[]" value="3" id="timing3" style="">
                                              </div>
                                              <label for="timing3" style="">
                                                  <p id="timing3">Slot 3<br>6:00 PM - 9:00 PM</p>
                                              </label>
                                          </div>
                                            </div>
                                        </div>
