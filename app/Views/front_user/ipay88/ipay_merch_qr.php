...
:checked + i.mdi{
  transform: scale(0.9);
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col">
					<form action="<?php echo base_url(); ?>/archanai_booking/initiate_ipay_merch_qr/<?php echo $arch_book_id; ?>" id="ipay_qr_form" method="post">
					...
					<script type="text/javascript">
						...
						scanner.addListener('scan',function(content){
							...
							//alert(content);
							/* setTimeout(function(){
								location.href= 'https://templeganesh.grasp.com.my/ipay88/new.php?barcode=' + content;
							}, 3500); */
