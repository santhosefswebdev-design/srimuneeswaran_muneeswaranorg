...
<hr>
<p style="text-align:center; font-size:16px;"> <b>Cash Donation Voucher </b></p><br>
<p><b>Date : </b> <?php $date= new DateTime($qry1['date']) ;  echo $date->format('d-m-Y'); ?></p>
<p><b>Invoice : </b> <?php echo $qry1['ref_no']; ?></p>
<p><b>Name : </b><?php echo $qry1['name']; ?></p>
<p><b>Payfor : </b><?php echo $qry1['pname']; ?></p>
