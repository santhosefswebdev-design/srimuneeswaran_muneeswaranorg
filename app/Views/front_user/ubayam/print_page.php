...
<hr>
<p style="text-align:center; font-size:16px;"> <b>Ubayam Voucher </b></p><br>
<p><b>Date : </b> <?php $date= new DateTime($qry1['dt']) ;  echo $date->format('d-m-Y'); ?></p>
<p><b>Invoice : </b> <?php echo $qry1['ref_no']; ?></p>
<p><b>Name : </b><?php echo $qry1['name']; ?></p>
<p><b>Amount(RM) : </b><?php echo number_format($qry1['amount'], '2','.',','); ?></p>
<p><b>Paid Amount(RM) : </b><?php echo number_format($qry1['paidamount'], '2','.',','); ?></p>
<p><b>Balance Amount(RM) : </b><?php echo ($qry1['balanceamount'] > 0) ? number_format($qry1['balanceamount'], '2','.',',') : 0.00; ?></p>
