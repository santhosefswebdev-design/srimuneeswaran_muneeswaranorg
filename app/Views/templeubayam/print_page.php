		...
		<div class="table-responsive col-md-12" style="background:#FFF; float:none;margin-bottom:0px;">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        Booking Date: <?php echo date('d-m-y', strtotime($data['entry_date'])); ?>
                    </td>
                </tr>
				<tr>
                    <td style="text-align: center;">
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php echo $packages['quantity']; ?></td>
                        <td>$<?php echo $packages['amount']; ?></td>
                        <td>$<?php echo $packages['quantity'] * $packages['amount']; ?></td>
                    </tr>
                    ...
                    <?php if(!empty($booked_addon)){ ?>
                        ...
                        <tr>
                            ...
                            <td>$<?php echo $addon['amount']; ?></td>
                            <td>$<?php echo $addon['quantity'] * $addon['amount']; ?></td>
                        </tr>
						<?php } ?>
					<?php } ?>
					...
					<?php if(!empty($abishegam)){ ?>
                        ...
                        <tr>
                            ...
                            <td>$<?php echo $row['quantity'] * $row['amount']; ?></td>
                        </tr>
						<?php } ?>
					<?php } ?>
					...
					<?php if(!empty($prasadam)){ ?>
                        ...
                        <tr>
                            <td class="right-align">Prasadam - <?php echo $row['name_eng']; ?>: <?php echo $row['deity_name']; ?></td>
                            <td><?php echo $row['quantity']; ?></td>
                            <td>$<?php echo $row['amount']; ?></td>
                            <td>$<?php echo $row['quantity'] * $row['amount']; ?></td>
                        </tr>
					...
					<?php if(!empty($annathanam)){ ?>
                        ...
                        <tr>
                            <td class="right-align">Annathanam - <?php echo $row['name_eng']; ?></td>
                            <td><?php echo $row['no_of_pax']; ?></td>
                            <td>$<?php echo $row['amount']; ?></td>
                            <td>$<?php echo $row['no_of_pax'] * $row['amount']; ?></td>
                        </tr>
						<?php } ?>
					<?php } ?>
					...
					<?php if(!empty($annathanam_addons)){ ?>
                        ...
                        <tr>
                            ...
                            <td>$<?php echo $row['quantity'] * $row['item_amount']; ?></td>
                        </tr>
						<?php } ?>
					<?php } ?>

                    <?php if(!empty($booked_extra)){ 
						foreach($booked_extra as $extra){ ?>
                        <tr>
