...
<tr><td align="left"><b>Date :</b> <?php $date= new DateTime($data['date']) ;  echo $date->format('d-m-Y'); ?></td>
<td align="right"><p style="text-align:right; line-height:1.7em;"><b>Invoice :</b> <?php echo $data['ref_no']; ?></p></td></tr>
<tr>
	<td colspan="2">
		<table border="1" style="border:1px solid #CCC;" width="100%" align="center">
			<tr><td width="40%"><b>Name </b> </td><td width="60%"><?php echo $data['name']; ?></td></tr>
			<?php
			if($data['type'] == 1){
			?>
				<tr><td><b>Deduction Month </b> </td><td><?php echo date('F, Y',strtotime($data['deduction_month'])); ?></td></tr>
				<tr><td><b>Deduction Amount (RM) </b> </td><td><?php echo number_format($data['amount'], '2','.',','); ?></td></tr>
			<?php
			}
			if($data['type'] == 2){
			?>
			<tr><td><b>Loan Amount (RM) </b> </td><td><?php echo number_format($data['total_amount'], '2','.',','); ?></td></tr>
			<tr><td><b>Processing Fee Amount (RM) </b> </td><td><?php echo number_format($data['provision_amount'], '2','.',','); ?></td></tr>
			<tr><td><b>EMI Amount (RM) </b> </td><td><?php echo number_format($data['amount'], '2','.',','); ?></td></tr>
			<tr><td><b>Total EMI Tenure</b> </td><td><?php echo $data['emi_count']; ?></td></tr>
			<tr><td><b>Loan Start Month </b> </td><td><?php echo date("F, Y", strtotime($data['emi_start_month'])); ?></td></tr>
			<?php
			}
			?>
			<tr><td><b>Amount In words </b> </td><td><?php echo AmountInWords($data['amount']); ?></td></tr>
		</table>
	</td>
</tr>
<tr><td colspan="2"><b>Remarks :</b> <?php echo $data['narration']; ?></td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td>Payment Agreed By :</td>
