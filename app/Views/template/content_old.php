...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <div class="col-md-12"><div class="card">
                    ...
                    <div class="body" style="padding:0;">
						...
						<div class="total">
							<div><?php echo $lang->total; ?> : SGD <span class="ar_total"><?php echo number_format($archanai_total, 2, '.', ''); ?></span></div>
						</div>
                    </div>
                </div>
                </div>
            ...
            <div class="col-md-12">
        <div class="card" style="min-height:20px !important">
                        ...
                        tooltip: {
                            callbacks: {
                                ...
                                afterLabel: function(context) {
                                    return 'Additional Info: ' + context.raw;
                                }
                            }
                        }
                    }
                ...
                <div class="col-md-12"><div class="card">
                    ...
                    <div class="body" style="padding:0;">
						...
						<div class="total" style="background:#00bcd4;">
							<div><?php echo $lang->total; ?> : SGD <span class="ha_total"><?php echo number_format($hall_total, 2, '.', ''); ?></span></div>
						</div>
                    </div>
                </div>
                </div>
                ...
                <div class="col-md-12"><div class="card">
                    ...
                    <div class="body" style="padding:0;">
						...
						<div class="total col-md-12" style="background:#8bc34a;">
							<div><?php echo $lang->total; ?> : SGD <span class="do_total"><?php echo number_format($donation_total, 2, '.', ''); ?></span></div>
						</div>
                    </div>
                </div>
            </div></div>
                ...
                <div class="col-md-12"><div class="card">
                    ...
                    <div class="body" style="padding:0;">
						...
						<div class="total" style="background:#ff9800;">
							<div><?php echo $lang->total; ?> : SGD <span class="ub_total"><?php echo number_format($ubayam_total, 2, '.', ''); ?></span></div>
						</div>
                    </div>
                </div>
...
<script>
$(function () {
    new Chart(document.getElementById("myPieChart").getContext("2d"), getChartJs('myPieChart'));
