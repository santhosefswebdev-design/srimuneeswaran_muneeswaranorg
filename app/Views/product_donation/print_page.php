...
<table style="width:100%">
	...
	<tr>
		<td colspan="2">
			<h2 style="text-align:center;"> Product Donation Voucher </h2>
		</td>
	</tr>
	<tr>
		...
		<td colspan="2">
			<table border="1" style="border:1px solid #CCC;" width="100%" align="center">
				...
				if (!empty($product_item)) {
					foreach ($product_item as $row_prod) {
						?>
						<tr>
							<td align="center">
								<?php echo $row_prod['pname']; ?>
							</td>
							<td align="center">
								<?php echo $row_prod['quantity']; ?>
							</td>
							<td align="center">
								<?php echo $row_prod['uom_range']; ?>
							</td>
							<td align="center">
								<?php echo $row_prod['uom']; ?>
							</td>
							<td align="center">
								<?php echo $row_prod['amount']; ?>
							</td>
							<td align="center">
								<?php echo $row_prod['total_amount']; ?>
							</td>
						</tr>
						<?php
						$total_amt = $total_amt + $row_prod['total_amount'];
					}
				}
				?>
			</table>
	...
	<tr>
		<td colspan="2"><b>Amount In words :</b>
			<?php echo AmountInWords($total_amt); ?>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2">
			...
			<p>To the best of my knowledge, this product donation emanated from a clean source by virtue of any law.
				This donation is done willingly without any duress purported for the Temple usefor whatsoever reason.
	...
	<tr>
		<td colspan="2">
			<?php if (!empty($terms['product_donation'])) { ?>
				<p>
					<?php echo $terms['product_donation']; ?>
				</p>
			<?php } ?>
		</td>
	</tr>
