  ...
  foreach ($qry1_payfor as $row) {
    ...
    for ($j = 0; $j < $qty; $j++) { ?>
      ...
      <div style="width: 80mm; height:275mm; font-weight: 600;font-family: monospace;">
        <p style="font-size: 12px;"><img src="<?php echo base_url(); ?>/uploads/main/<?php echo $temp_details['image']; ?>"
            style="width:110px;" align="center"></p>
        ...
        <?php $row['amount']; ?>
        <hr>
        <p style="text-align: center; font-size: 24px; padding-bottom: 25px;">Total: SGD
          <?= number_format($row['amount'], 2); ?>
        </p>
        <hr>
        <br>
