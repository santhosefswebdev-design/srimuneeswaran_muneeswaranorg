...
<tr><td colspan="2"><h2 style="text-align:center;"> Prasadam Voucher </h2></td></tr>
<tr><td align="left"><b>Date :</b> <?php $date= new DateTime($qry1['dt']) ;  echo $date->format('d-m-Y'); ?></td>
<td align="right"><p style="text-align:right; line-height:1.7em;"><b>Invoice :</b> <?php echo $qry1['id']; ?></p></td></tr>
<tr><td colspan="2">
    <table border="1" style="border:1px solid #CCC;" width="90%" align="center">
    <tr><td width="40%"><b>Prasadam Name </b> </td><td width="60%"><?php echo $qry1['name']; ?></td></tr>
    <tr><td><b>Date </b> </td><td><?php echo date("d-m-Y", strtotime($qry1['date'])); ?></td></tr>
    <tr><td><b>Customer Name </b> </td><td><?php echo $qry1['customer_name']; ?></td></tr>
    <tr><td><b>Amount(RM) </b> </td><td><?php echo number_format($qry1['amount'], '2','.',','); ?></td></tr>
	<tr><td><b>Collection Date </b> </td><td><?php echo date("d-m-Y", strtotime($qry1['collection_date'])); ?></td></tr>
	<tr>
	...
	<tr>
		...
		<td>
			<?php 
			if(!empty($qry1['end_time'])){
				echo date("H:i:s", strtotime($qry1['end_time']));
			}
			else{
				echo "";
			}
...
<tr><td colspan="2"><b>Remarks :</b> <?php echo $qry1['desciption']; ?></td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td>Prasadam Agreed By :</td>
