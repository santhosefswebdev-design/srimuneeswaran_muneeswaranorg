                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="header">
                            ...
                            <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/news_events/add"><button type="button" class="btn bg-deep-purple waves-effect"><?php echo $lang->add; ?></button></a></div></div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['image']; ?></td>
                                                ...
                                                <td style="width: 10%;">
                                                        ...
                                                        <a class="btn btn-success btn-rad" title="View" href="<?= base_url()?>/news_events/view/<?php echo $row['id'];?>"><i class="material-icons">&#xE417;</i></a>
                                                   
													
                                                        <a class="btn btn-primary btn-rad" title="Edit" href="<?= base_url()?>/news_events/edit/<?php echo $row['id'];?>"><i class="material-icons">&#xE3C9;</i></a>
                                                   
													
                                                        <a class="btn btn-danger btn-rad" title="Delete" href="<?= base_url()?>/news_events/delete/<?php echo $row['id'];?>"><i class="material-icons">&#xE872;</i></a>                                                
...
<script>
    function confirm_modal(id)
    {
		//alert(id)
        $.ajax({
            url: "<?php echo base_url();?>/news_events/del_check",
            type: "post",
            data: {id: id},
    ...
    function dedDel(id)
    {
        var act = "<?php echo base_url(); ?>/news_events/delete/"+id;
