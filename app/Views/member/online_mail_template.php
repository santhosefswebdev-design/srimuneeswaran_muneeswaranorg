...
?>
	<table style="width:50%;margin:0 auto;background-image: linear-gradient(#2a2728, #e51311);background-size:100% 100%;padding:20px;">
		<tbody>
			...
			<tr>
				<td align="center">
					<p style="color:#ffffffe3;font-family: system-ui; margin:0.5em;">We are glad that you have decided to join us here at <?php echo $temple_details['name']; ?>, and appreciate your effort to make the organization a better place for current and future temples</p>
				</td>
			</tr>
