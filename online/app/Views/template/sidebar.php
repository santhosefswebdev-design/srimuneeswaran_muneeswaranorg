      ...
      <ul class="links">
        ...
        <?php if ($archanai_setting || $archanai_ticket || $archanai_report) { ?>
          <li><a href="#"><img src="<?php echo base_url(); ?>/assets/images/archanai.png"
                style="width:50px; display:block;"><span>
                <?php echo $lang->archanai; ?> <i class='bx bxs-chevron-down htmlcss-arrow arrow  '></i>
              </span></a>
          ...
          <li><a href="#"><img src="<?php echo base_url(); ?>/assets/images/account.png"
            ...
            <ul class="js-sub-menu sub-menu">
              ...
              if ($balance_sheet_accounts) { ?>
                <li><a href="<?php echo base_url(); ?>/balance_sheet/balancesheet_rightcode_triplezero">
              ...
              <li><a href="<?php echo base_url(); ?>/report/ledger_rep_view">
                  <?php echo $lang->ledger; ?>
                  <?php echo $lang->report; ?>
                </a></li>
        ...
        <?php }
        if ($user_setting || $staff_setting || $pay_slip || $commission_report || $payslip_report) { ?>
      ...
      <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
          <ul class="list">
            ...
            <li>
              <a href="#"><img src="<?php echo base_url(); ?>/assets/images/donation.png"
                  style="width:50px; display:block;"><span>Property <i
                    class='bx bxs-chevron-down htmlcss-arrow arrow  '></i></span></a>
              <ul class="htmlCss-sub-menu sub-menu">
                <li><a href="<?php echo base_url(); ?>/master/property_type">Property Type</a></li>
                <li><a href="<?php echo base_url(); ?>/master/property_title">Property Title</a></li>
                <li><a href="<?php echo base_url(); ?>/master/rental_type">Rental Type</a></li>
                <li><a href="<?php echo base_url(); ?>/properties">Properties</a></li>
                <li><a href="<?php echo base_url(); ?>/rental">Rental Payment</a></li>
                <li><a href="<?php echo base_url(); ?>/rental/default_list">Rental Default</a></li>
                <li><a href="<?php echo base_url(); ?>/tennant">Tenancy Details</a></li>
              </ul>
            </li>
