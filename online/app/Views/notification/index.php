...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2> NOTIFICATION<small>Member / <b>Member Notification</b></small></h2>
            </div>
            <!-- Basic Examples -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/notification/add"><button type="button" class="btn bg-deep-purple waves-effect">Add</button></a></div></div>
                        </div>
                        <div class="body">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 16%;">
                                                <a class="btn btn-success btn-rad" href="<?= base_url()?>/notification/view/<?php echo $row['id'];?>"><i class="material-icons">&#xE417;</i></a>
												<a class="btn btn-warning btn-rad" href="<?= base_url()?>/notification/edit/<?php echo $row['id'];?>"><i class="material-icons">&#xE3C9;</i></a>
