(function($) {
  ...
  $(function() {
    ...
    if ($.cookie('pollux-free-banner')!="true") {
    ...
    document.querySelector('#bannerClose').addEventListener('click',function() {
      ...
      document.querySelector('.navbar').classList.add('fixed-top');
      document.querySelector('.navbar-breadcrumb').classList.add('proBanner-padding-top');
      document.querySelector('.navbar').classList.remove('mt-5');
      var date = new Date();
      date.setTime(date.getTime() + 24 * 60 * 60 * 1000); 
      $.cookie('pollux-free-banner', "true", { expires: date });
    });
